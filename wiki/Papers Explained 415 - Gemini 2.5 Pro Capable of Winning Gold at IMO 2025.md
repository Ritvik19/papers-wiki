...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Large Language Models]], [[Verifier-Bounded Learning]], [[Reinforcement Learning]].
...
- In the second step, the model is prompted to review and try to improve their work. The model almost always uses up its thinking budget in Step 1. Thus, the model does not even have the capacity to fully solve the problem.
- In Step 3, the verifier is used to generate a bug report for each solution outputted in Step 2. The bug report contains a list of issues classified as critical errors or justification gaps. For each issue, an explanation is required.
...
Gemini 2.5 Pro Capable of Winning Gold at IMO 2025 [2507.15855](https://arxiv.org/abs/2507.15855)
