...
- Source file: `raw/2025-03-28_Papers-Explained-340--CHASE-84857503f39c.html`
...
Figures from the Medium HTML export (`raw/2025-03-28_Papers-Explained-340--CHASE-84857503f39c.html`); local copies under `wiki/assets/papers-explained-340-chase/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-340-chase/fig-1.png) | Title card: CHASE. |
| ![Figure 2](assets/papers-explained-340-chase/fig-2.png) | The high-level ideas behind the CHASE framework. |
| ![Figure 3](assets/papers-explained-340-chase/fig-3.png) | This also facilitates fine-grained verification. |
| ![Figure 4](assets/papers-explained-340-chase/fig-4.png) | GPT-4o is used as the generator G, and GPT-4o-mini as the verifier V. |
| ![Figure 5](assets/papers-explained-340-chase/fig-5.png) | GPT-4o-mini is used as G, and Gemini-1.5-Flash as V. |
| ![Figure 6](assets/papers-explained-340-chase/fig-6.png) | The performance of various LLMs on all 3 domains of the CHASE benchmark. |
| ![Figure 7](assets/papers-explained-340-chase/fig-7.png) | Performance of LLMs on data generated by direct prompting approaches without using CHASE. |
| ![Figure 8](assets/papers-explained-340-chase/fig-8.png) | This process is carried out 3 times. |
| ![Figure 9](assets/papers-explained-340-chase/fig-9.png) | This process is carried out 3 times. |
## Related
