...
CHallenging AI with Synthetic Evaluations (CHASE) is a unified framework to synthetically generate challenging problems using LLMs without human involvement. For a given task, the approach builds a hard problem in a bottom-up manner from simpler components.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Synthetic Data]], [[Evaluation and Benchmarks]], [[Code Models]], [[Reinforcement Learning Topic]], [[Reasoning Models]], [[Verifier-Bounded Learning]], [[Reinforcement Learning]].

## Source Metadata

- Source file: `raw/2025-03-28_Papers-Explained-340--CHASE-84857503f39c.md`
- Source title: Papers Explained 340: CHASE
- Published: 2025-03-28
- Canonical: [https://medium.com/@ritvik19/papers-explained-340-chase-84857503f39c](https://medium.com/@ritvik19/papers-explained-340-chase-84857503f39c)
...
- This grants more control over each step of the generation process. Each step can be treated as a task by itself and the corresponding inference parameters can be optimized individually.
- This also facilitates fine-grained verification. LLMs that are not part of the generation process are deployed to check the correctness and quality of the generated data at each step.
...
*Figure: The high-level ideas behind the CHASE framework.*
...
```text
System Prompt: You are an expert at verifying data.
---
...
*Figure: The performance of various LLMs on all 3 domains of the CHASE benchmark.*
...
*Figure: Performance of LLMs on data generated by direct prompting approaches without using CHASE.*
...
How to Get Your LLM to Generate Challenging Problems for Evaluation [2502.14678](https://arxiv.org/abs/2502.14678)

## Figures

Figures from the Medium HTML export (`raw/2025-03-28_Papers-Explained-340--CHASE-84857503f39c.md`); local copies under `wiki/assets/papers-explained-340-chase/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-340-chase/fig-1.webp) | Title card: CHASE. |
| ![Figure 2](assets/papers-explained-340-chase/fig-2.webp) | The high-level ideas behind the CHASE framework. |
| ![Figure 3](assets/papers-explained-340-chase/fig-3.webp) | This also facilitates fine-grained verification. |
| ![Figure 4](assets/papers-explained-340-chase/fig-4.webp) | GPT-4o is used as the generator G, and GPT-4o-mini as the verifier V. |
| ![Figure 5](assets/papers-explained-340-chase/fig-5.webp) | GPT-4o-mini is used as G, and Gemini-1.5-Flash as V. |
| ![Figure 6](assets/papers-explained-340-chase/fig-6.webp) | The performance of various LLMs on all 3 domains of the CHASE benchmark. |
| ![Figure 7](assets/papers-explained-340-chase/fig-7.webp) | Performance of LLMs on data generated by direct prompting approaches without using CHASE. |
| ![Figure 8](assets/papers-explained-340-chase/fig-8.webp) | This process is carried out 3 times. |
| ![Figure 9](assets/papers-explained-340-chase/fig-9.webp) | This process is carried out 3 times. |
## Related
