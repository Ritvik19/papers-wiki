...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Large Language Models]], [[Reinforcement Learning Topic]], [[Code Models]], [[Synthetic Data]], [[Supervised Fine-Tuning]], [[Reinforcement Learning]].
...
- The models and data are available on [HuggingFace](https://huggingface.co/collections/nvidia/acereason-682f4e1261dc22f697fd1485/).
...
- Math-only Stage-2 (16K): At this stage of training, the proportion of more challenging questions is increased compared to Stage 1.
...
*Figure: Training Pipeline of AceReason-Nemotron 1.1.*
...
*Figure: Evaluation of reasoning models primarily based on Qwen2.5-Math 7B and Llama-3.1 8B to disentangle the impact of pretraining.*
...
*Figure: Log-scaled data statistics for the number of math and code prompts and the average number of responses per prompt.*

*Figure: Accuracies on AIME24, AIME25, and LiveCodeBench V5 and V6 for different SFT datasets.*
...
*Figure: Accuracies over different epochs of training for SFT dataset v6 and v7.*
...
*Figure: Math-only RL training starting from different SFT (distillation) models.*
...
*Figure: Impact of varying temperatures for inference and RL training.*
...
*Figure: Comparison of pass@K scores between AceReason-Nemotron-1.1–7B and the SFT-7B v7 model it is trained from.*
...
*Figure: Comparison of problem-level solving rates between AceReason-Nemotron1.1–7B and the SFT-7B v7 model it is trained from.*
...
AceReason-Nemotron 1.1: Advancing Math and Code Reasoning through SFT and RL Synergy [2506.13284](https://arxiv.org/abs/2506.13284)
