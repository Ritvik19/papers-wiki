...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Safety and Alignment]], [[Reasoning Models]], [[Large Language Models]], [[Reinforcement Learning Topic]], [[Evaluation and Benchmarks]], [[Reinforcement Learning]].
...
*Figure: Comparison of different external TTS methods.*
...
*Figure: Performance of Llama-3.1–8B-Instruct and Qwen2.5–7B-Instruct on MATH-500 with different PRMs and TTS strategies.*
...
*Figure: Performance of Llama-3.1–8B-Instruct and Qwen2.5–7B-Instruct on AIME24 with different PRMs and TTS strategies.*
...
*Figure: The relationship between TTS performance and process supervision abilities of different PRMs on MATH.*
...
*Figure: TTS performance of policy models with parameters from 0.5B to 72B on MATH-500 with different scaling methods.*
...
*Figure: TTS performance of Qwen and Llama policy models on MATH-500 with different difficulty levels.*
...
*Figure: Statistics of training data of RLHFlow PRMs.*
...
*Figure: Performance of TTS with different voting methods on MATH-500.*
...
*Figure: Comparison of small policy models with frontier reasoning LLMs (CoT) on MATH-500 and AIME24.*
...
*Figure: FLOPS comparison between smaller policy models (compute-optimal TTS) and larger ones (CoT).*

- Small policy models with TTS achieved superior performance with 100x to 1000x fewer FLOPS compared to larger models.

## Q5: How does compute-optimal TTS improve compared with CoT and majority voting?

*Figure: Comparison of compute-optimal TTS, CoT, and majority voting with different policy models on MATH-500.*
...
*Figure: Comparison of compute-optimal TTS with long-CoT methods on MATH-500 and AIME24.*
