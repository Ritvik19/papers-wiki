...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Multilingual Models]], [[Large Language Models]], [[Synthetic Data]], [[Model Compression and Efficiency]].
...
- Recommended Reading [Papers Explained 108: Aya Dataset](https://ritvik19.medium.com/papers-explained-108-aya-dataset-9e299ac74a19)
- The training data curation includes relying on extensive efforts to aggregate and prune multilingual templates and hard-to-find human annotations curated by fluent speakers of various languages.
...
- xP3x (Cross Lingual Public Pool of Prompts eXtended) extends xP3 from 86M examples across 46 languages and 13 tasks to 680M examples across 277 languages and 16 tasks.
...
*Figure: A list of training data sources used for instruction finetuning Aya models.*
...
*Figure: Language grouping for the Aya model training mixture.*
...
[Read More](https://ritvik19.medium.com/papers-explained-108-aya-dataset-9e299ac74a19)

### Human Annotations

Here, the focus is on introducing new multilingual human annotations through the Aya dataset [Read More](https://ritvik19.medium.com/papers-explained-108-aya-dataset-9e299ac74a19)
...
*Figure: Data sampling ablation with different weighting schemes for each data source for training.*
...
*Figure: Results for held-out task evaluation.*
...
*Figure: Multilingual MMLU score comparisons between Okapi, mT0, mT0x, and Aya models.*
...
*Figure: Generative tasks’ results for mT0x and Aya model variants based on different weighting ablations.*
...
*Figure: Generative and discriminative performance of the Aya (translated-heavy) model compared to mT0x across high (HR), medium (MR), and low-resource (LR) language groups.*
...
Aya Model: An Instruction Finetuned Open-Access Multilingual Language Model [2402.07827](https://arxiv.org/abs/2402.07827)

Recommended Reading [Multi Task Language Models](https://ritvik19.medium.com/list/multi-task-language-models-e6a2a1e517e6) [Aya Series](https://ritvik19.medium.com/list/aya-series-83ee469cf14f)
...
- [[C4AI Launches Aya, an LLM Covering More Than 100 Languages]] — official launch post for the broader Aya open-science initiative.
