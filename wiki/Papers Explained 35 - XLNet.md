...
- Source file: `raw/2023-03-13_Papers-Explained-35--XLNet-ea0c3af96d49.html`
...
Figures from the Medium HTML export (`raw/2023-03-13_Papers-Explained-35--XLNet-ea0c3af96d49.html`); local copies under `wiki/assets/papers-explained-35-xlnet/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-35-xlnet/fig-1.png) | Title card: XLNet. |
| ![Figure 2](assets/papers-explained-35-xlnet/fig-2.png) | XLNet proposes a new method for pretraining language models that combines ideas from AR and AE objectives while avoiding their limitations... |
| ![Figure 3](assets/papers-explained-35-xlnet/fig-3.png) | XLNet also uses a modified version of the Transformer architecture, called the “Transformer-XL,” which is designed to capture long-range... |
| ![Figure 4](assets/papers-explained-35-xlnet/fig-4.png) | The same architecture hyperparameters as BERT-Large are used in XLNet-Large. |
| ![Figure 5](assets/papers-explained-35-xlnet/fig-5.png) | The same architecture hyperparameters as BERT-Large are used in XLNet-Large. |
| ![Figure 6](assets/papers-explained-35-xlnet/fig-6.png) | The same architecture hyperparameters as BERT-Large are used in XLNet-Large. |
| ![Figure 7](assets/papers-explained-35-xlnet/fig-7.png) | The same architecture hyperparameters as BERT-Large are used in XLNet-Large. |
| ![Figure 8](assets/papers-explained-35-xlnet/fig-8.png) | The same architecture hyperparameters as BERT-Large are used in XLNet-Large. |
## Related
