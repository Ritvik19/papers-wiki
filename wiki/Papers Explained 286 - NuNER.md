...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Embedding and Retrieval]], [[Reasoning Models]], [[Synthetic Data]], [[Model Compression and Efficiency]], [[Audio Models]]. Official precursor blog: [[A Foundation Model for Entity Recognition]] (Nov 2023); see [[NuMind]].
...
- NuNER is a compact language representation model specialized in the Named Entity Recognition (NER) task.
- The models are available on [HuggingFace](https://huggingface.co/collections/numind/nuner-token-classification-and-ner-backbones-65e1f6e14639e2a465af823b).
- The goal is to create a dataset for entity recognition. Label as many entities, concepts, and ideas as possible in the input text. Invent new entity types that may not exist in traditional NER Tasks such as more abstract concepts and ideas.
...
*Figure: NuNER creation procedure.*
...
*Figure: Feature map of the 50k most common concepts extracted by gpt-3.5-turbo-0301. Embeddings are obtained from the concept encoder.*
...
*Figure: Frequency of each concept assigned by GPT-3.5.*
...
*Figure: NuNER’s pre-tranining procedure.*
...
*Figure: Few-NERD performance using TadNER and a modified TadNER using NuNER-BERT as the backbone.*
...
*Figure: Comparison of NuNER with LLMs.*
...
*Figure: NuNER vs. UniversalNER few-shot entity-level F1-score in the k ∼ 2k setting.*
...
NuNER: Entity Recognition Encoder Pre-training via LLM-Annotated Data [2402.15343](https://arxiv.org/abs/2402.15343)
