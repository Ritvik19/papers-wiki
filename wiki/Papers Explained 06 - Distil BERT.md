...
- Source file: `raw/2023-02-06_Papers-Explained-06--Distil-BERT-6f138849f871.html`
...
Figures from the Medium HTML export (`raw/2023-02-06_Papers-Explained-06--Distil-BERT-6f138849f871.html`); local copies under `wiki/assets/papers-explained-06-distil-bert/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-06-distil-bert/fig-1.png) | Title block of *DistilBERT, a distilled version of BERT: smaller, faster, cheaper and lighter*. |
| ![Figure 2](assets/papers-explained-06-distil-bert/fig-2.png) | Distillation cross-entropy loss over teacher and student soft targets. |
| ![Figure 3](assets/papers-explained-06-distil-bert/fig-3.png) | Temperature-scaled softmax and the combined DistilBERT pretraining objective (MLM + distillation + cosine alignment). |
| ![Figure 4](assets/papers-explained-06-distil-bert/fig-4.png) | DistilBERT results summary: GLUE retention, downstream IMDb/SQuAD performance, and inference-time/parameter-size comparisons. |
## Related
