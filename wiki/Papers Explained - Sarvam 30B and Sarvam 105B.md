...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Multilingual Models]], [[Mixture of Experts]], [[Reasoning Models]], [[Reinforcement Learning Topic]], [[Long Context]], [[Supervised Fine-Tuning]], [[Reinforcement Learning]].
...
- Both models share a common architectural principle: high-capacity reasoning with efficient training and deployment.
- While the two models share the same design philosophy, they differ in scale and attention mechanism. Sarvam 30B uses Grouped Query Attention (GQA) to reduce KV-cache memory while maintaining strong performance.
...
- Pre-training was conducted in three phases, covering long-horizon pre-training, mid-training, and a long-context extension phase.
- During supervised fine-tuning, the model is trained on a large corpus of high-quality prompts curated for difficulty, quality, and domain diversity.
...
*Figure: Sarvam 105B: All Benchmarks.*
...
*Figure: Sarvam 30B:All Benchmark.*
...
*Figure: Sarvam 105B Indic Win Rate.*
...
*Figure: Sarvam 30B Indic Win Rate.*
