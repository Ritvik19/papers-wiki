...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Audio Models]], [[Large Language Models]], [[Synthetic Data]], [[Model Compression and Efficiency]], [[Vision Language Models]].
...
- Extends Phi-4-Mini with vision and speech/audio modalities via a novel “mixture of LoRAs” approach, enabling combined modality inference without interference and achieving state-of-the-art performance in various multimodal tasks while maintaining the base...
- Phi-4-Mini is a 3.8B parameter language model trained on high-quality web and synthetic data, significantly outperforming recent open-source models of similar size and matching the performance of models twice its size on math and coding tasks requiring...
- Phi-4-Multimodal is a multimodal model that integrates text, vision, and speech/audio input modalities into a single model.
- The speech/audio inputs used are 80-dim log-Mel filter-bank features with the frame rate of 10ms. To enable Phi-4-Multimodal speech and audio functions, a pre-trained audio encoder and Phi-4-Mini are connected through an audio adapter.
- An audio encoder, which consists of 3 convolution layers and 24 conformer blocks with 1024 attention dimensions, 1536 feed-forward dimensions, and 16 attention heads.
...
*Figure: A overview of the Multimodal architecture for Phi-4-Multimodal.*
...
*Figure: Phi-4-Mini language benchmark scores.*
...
*Figure: Phi-4-Mini coding performance comparison.*
...
*Figure: CoT Reasoning results of reasoning-enhanced Phi-4-Mini.*
...
*Figure: Comparison results on public vision-language benchmarks*

*Figure: Comparison results on public vision-speech benchmarks.*
...
*Figure: Main Results on the speech benchmarks.*

*Figure: Detailed results on ASR benchmarks, with CER (↓) for JA and ZH, and WER (↓) for other
languages.*

*Figure: Detailed results on AST benchmarks with BLEU (↑) score reported.*

*Figure: Result details on speech QA/summarization/audio understanding tasks for multi-modal models.*
...
[Phi-4-Mini Technical Report: Compact yet Powerful Multimodal Language Models via Mixture-of-LoRAs](https://cdn-lfs-us-1.hf.co/repos/8d/71/8d718e13494c4770e646730220348226dc6f16b1ae91e1794ff924d26ede1da7/a5469d9123cbee2b41729db3217cacfeaa96eaf543868caa2eeec7cf2d24547d?response-content-disposition=inline%3B+filename*%3DUTF-8%27%27phi_4_mm.tech_report.02252025.pdf%3B+filename%3D%22phi_4_mm.tech_report.02252025.pdf%22%3B&response-content-type=application%2Fpdf&Expires=1740981775&Policy=&Signature=L1YnbYRr0A0XAZ2UqYVlEgGYm0egzOq25aHNP0d2hPjNjnSX423YqUFEYvvEkogy1etRzXI-C8ErsB7hvAMnFWJW9pl3jjOwe9XeZM7Vg2p901x4bjXg2-%7EtW1NDPMPEtf1RekuUnfpFFPYQwURXTjoQN6BV-9AEuZeIQFsPcj%7EbsX5WtwrBN11IIfulienN71OCxvz6mJdB3xW6x3q%7EEj0vINw-QH2lA5Jg0EsSbV9qyZ04xltYSIiwcuAvk-bttF7FLWkdiTFW5V3bx4T09q1ojjxw6oH2pK4Z7OzrPv3H5XQ5aywpK4ZHhrBZg2etixE2wsN5OKcQ2eHaJ%7E8XZw__&Key-Pair-Id=K24J24Z295AEI9)
