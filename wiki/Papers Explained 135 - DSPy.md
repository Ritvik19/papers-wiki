...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Agentic AI]], [[Code Models]], [[Reasoning Models]], [[Large Language Models]].
...
- DSPy modules are task-adaptive components — similar to neural network layers — that abstract any particular text transformation, like answering a question or summarizing a paper.
...
- [dspy.Predict](https://dspy-docs.vercel.app/api/modules/Predict): Basic predictor. Does not modify the signature. Handles the key forms of learning (i.e., storing the instructions and demonstrations and updates to the LM).

- [dspy.ChainOfThought](https://dspy-docs.vercel.app/api/modules/ChainOfThought): Teaches the LM to think step-by-step before committing to the signature's response.

- [dspy.ProgramOfThought](https://dspy-docs.vercel.app/api/modules/ProgramOfThought): Teaches the LM to output code, whose execution results will dictate the response.

- [dspy.ReAct](https://dspy-docs.vercel.app/api/modules/ReAct): An agent that can use tools to implement the given signature.

- [dspy.MultiChainComparison](https://dspy-docs.vercel.app/api/modules/MultiChainComparison): Can compare multiple outputs from ChainOfThought to produce a final prediction.
...
The DSPy compiler operates through three main stages:
...
optimized_program = teleprompter.
compile
(
...
*Figure: Results with in-context learning on GSM8K math word problems.*
...
- [DSPy 🤝 LangChain](https://www.kaggle.com/code/ritvik1909/dspy-langchain)

## Paper

DSPy: Compiling Declarative Language Model Calls into Self-Improving Pipelines [2310.03714](https://arxiv.org/abs/2310.03714)
