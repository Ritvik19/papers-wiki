...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Embedding and Retrieval]], [[Large Language Models]], [[Model Compression and Efficiency]].
...
- The current open-source text embedding models struggle to represent lengthy documents and often resort to truncation, requiring splitting documents into smaller paragraphs for embedding, resulting in a much larger set of vectors, leading to increased memory...
...
- Recommended Reading [Papers Explained 263: Jina Embeddings v1](https://ritvik19.medium.com/papers-explained-263-jina-embeddings-v1-33336e9efb0f)
...
*Figure: Architecture specifications for the Jina BERT models of varying sizes.*
...
*Figure: Evaluation of the Jina BERT models on the GLUE benchmark.*

- JinaBERT achieves competitive results on the GLUE benchmark.

*Figure: Variation of model MLM accuracy w.r.t. the sequence length.*
...
*Figure: Evaluation of the Jina Embeddings v2 models on the MTEB benchmark.*
...
*Figure: Evaluation w.r.t. maximum sequence length.*
...
Jina Embeddings 2: 8192-Token General-Purpose Text Embeddings for Long Documents [2310.19923](https://arxiv.org/abs/2310.19923)
