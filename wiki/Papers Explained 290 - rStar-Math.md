...
rStar-Math demonstrates that small language models (SLMs) can rival or even surpass the math reasoning capability of OpenAI o1, without distillation from superior models.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Model Compression and Efficiency]], [[Reinforcement Learning Topic]], [[Large Language Models]], [[Code Models]], [[Reinforcement Learning]], [[Model Distillation]].
...
- The step-by-step generation in MCTS naturally yields step-level training data for both models.
- LLMs can hallucinate, producing incorrect steps that coincidentally lead to the correct answer. These flawed steps are hard to identify, hence, a code-augmented Chain-of-Thought approach.
...
*Figure: An example of Code-augmented CoT.*
...
*Figure: The results of rStar-Math and other frontier LLMs on the most challenging math benchmarks.*
...
*Figure: Reasoning performance under scaling up the test-time compute.*
...
rStar-Math: Small LLMs Can Master Math Reasoning with Self-Evolved Deep Thinking [2501.04519](https://arxiv.org/abs/2501.04519)
