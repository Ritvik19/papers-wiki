...
Command R is a 35B LLM designed for production-scale AI in enterprises. It is a scalable generative model that balances efficiency with accuracy, enabling companies to move beyond proof-of-concept and into production.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Embedding and Retrieval]], [[Reasoning Models]], [[Model Compression and Efficiency]], [[Long Context]], [[Large Language Models]], and the primary-source summary [[Introducing Command R+: A Scalable LLM Built for Business]].
...
- Model weights available on [HuggingFace](https://huggingface.co/CohereForAI/c4ai-command-r-v01)for research and evaluation.
...
*Figure: (left) Head-to-Head overall human preference evaluation on a range of enterprise-relevant RAG applications, taking fluency, answer utility and citations into consideration. (right) Average accuracy of an end-to-end evaluation of the Natural Questions, TriviaQA, and HotpotQA benchmarks.*
...
*Figure: Accuracy on 3-shot multi-hop REACT agents.*
...
*Figure: Comparison on multilingual MMLU*
...
*Figure: Long-context “Needles in a Haystack” Evaluation.*
...
Model weights available on [HuggingFace](https://huggingface.co/CohereForAI/c4ai-command-r-plus)for research and evaluation.

### Evaluation

*Figure: (left) Performance comparison across three key capabilities: Multilingual, RAG, and Tool Use. (right) Comparison input and output token costs per million for models available on Azure.*

- Command R + consistently beats Mistral Large and is on-par with GPT4-Turbo

Retrieval-Augmented Generation

*Figure: (left) Human head-to-head preference results. (right) Accuracy of multi-hop REACT agents*
...
*Figure: Evaluation of conversational tool-use and single-turn function-calling capabilities, using Microsoft’s ToolTalk (Hard) benchmark and Berkeley’s Function Calling Leaderboard (BFCL).*
...
*Figure: Comparison of models on FLoRES (in French, Spanish, Italian, German, Portuguese, Japanese, Korean, Arabic, and Chinese) and WMT23 (in German, Japanese, and Chinese) translation tasks.*
...
*Figure: Comparison of the number of tokens produced.*
...
"body"
:
"Man's dream has always been to find love. This profound lesson..."
}
]
input_ids = tokenizer.apply_chat_template(conversation=conversation, documents=documents, tokenize=
True
...
Source: [CohereForAI/c4ai-command-r7b-12–2024](https://huggingface.co/CohereForAI/c4ai-command-r7b-12-2024)
...
[Command R: Retrieval-Augmented Generation at Production Scale](https://cohere.com/blog/command-r)

[[Introducing Command R+: A Scalable LLM Built for Business]] — [canonical blog](https://cohere.com/blog/command-r-plus-microsoft-azure)

[Introducing Structured Outputs with JSON Response Format](https://cohere.com/blog/introducing-structured-outputs)

[Introducing Command R7B: Fast and efficient generative AI](https://cohere.com/blog/command-r7b)
