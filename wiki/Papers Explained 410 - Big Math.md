...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Reinforcement Learning Topic]], [[Synthetic Data]], [[Reinforcement Learning]], [[Verifier-Bounded Learning]].
...
- Big-Math is a dataset of over 250,000 high-quality math questions with verifiable answers, purposefully made for reinforcement learning (RL).
- problems with uniquely verifiable solutions
- To ensure the quality of Big-Math, each step in the filtering process is manually verified, and filters are iteratively improved over multiple rounds.
- The dataset is available at [HuggingFace](http://synthlabsai/Big-Math-RL-Verified).
...
*Figure: Comparison of problems by data source.*
...
*Figure: Distribution of solve rates on each subset of Big Math, calculated with Llama-3.1–8B.*
...
*Figure: Distribution of solve rates by domain, calculated with Llama-3.1–8B.*
...
Big-Math: A Large-Scale, High-Quality Math Dataset for Reinforcement Learning in Language Models [2502.17387](https://arxiv.org/abs/2502.17387)
