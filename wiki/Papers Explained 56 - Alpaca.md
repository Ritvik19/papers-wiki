...
- Source file: `raw/2023-09-18_Papers-Explained-56--Alpaca-933c4d9855e5.md`
...
Figures from the Medium HTML export (`raw/2023-09-18_Papers-Explained-56--Alpaca-933c4d9855e5.md`); local copies under `wiki/assets/papers-explained-56-alpaca/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-56-alpaca/fig-1.webp) | Title card: Alpaca. |
| ![Figure 2](assets/papers-explained-56-alpaca/fig-2.webp) | For the second challenge, instruction-following demonstrations were generated by building upon the self-instruct method. |
## Related
