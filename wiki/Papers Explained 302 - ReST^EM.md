...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Reinforcement Learning Topic]], [[Large Language Models]], [[Safety and Alignment]], [[Evaluation and Benchmarks]], [[Supervised Fine-Tuning]], [[Reinforcement Learning]].
...
- Unlike ReST, augmenting D𝑖 in the Generate step with human-generated outputs is refrained from as such data may not always be optimal for learning or it might not be easily available.
- The experiments focus on problem-solving settings with binary rewards (either 0 or 1), unlike the bounded real-valued rewards assumed by ReST.
- ReST-EM is applied to PaLM 2 models (S, S*, L) using the MATH and APPS datasets. Performance is evaluated on test sets of MATH, APPS, GSM8K, HumanEval, Big-Bench Hard, and the Hungarian high school finals math exam.
...
*Figure: ReST-EM for math problem-solving.*

*Figure: ReST-EM for code-generation.*
...
*Figure: Pass@K results for PaLM-2-L.*
...
*Figure: Left: Comparing ReST-EM with SFT on MATH. Right: Impact of Model-Generated Data for Distillation*
...
*Figure: ReST-EM vs ReST using PaLM 2-S*.*
...
*Figure: Left: Performance for a single iteration of ReST-EM as a function of dataset size. Right: Improvement from ReST-EM based on the difficulty level of the question.*
...
*Figure: Evaluations on Big-Bench Hard suite of tasks.*
...
Beyond Human Data: Scaling Self-Training for Problem-Solving with Language Models [2312.06585](https://arxiv.org/abs/2312.06585)
