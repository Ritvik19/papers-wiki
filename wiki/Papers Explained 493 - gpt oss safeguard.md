...
gpt-oss-safeguard-120b and gpt-oss-safeguard-20b are two open-weight reasoning models post-trained from the gpt-oss models. These models are trained to reason from a provided policy in order to label content under that policy.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Safety and Alignment]], [[Large Language Models]], [[Reasoning Models]], [[Model Compression and Efficiency]].

Official source: [[gpt-oss-safeguard]].
...
- The models are available on [HuggingFace](https://huggingface.co/collections/openai/gpt-oss-safeguard/). User Guide is available [here](https://cookbook.openai.com/articles/gpt-oss-safeguard-guide).
- gpt-oss-safeguard enables developers to draw the policy lines that best fit their use case. The model takes two inputs at once: a policy and the content to classify under that policy.
...
*Figure: Internal moderation evaluation (multi-policy accuracy).*
...
*Figure: OpenAI Moderation API and ToxicChat evaulations.*
...
*Figure: Standard Disallowed Content Evaluation.*
...
*Figure: Instruction Hierarchy Evaluation — System User message conflict.*

*Figure: Instruction Hierarchy Evaluation — Phrase and Password Protection.*
...
*Figure: Hallucination evaluations.*
...
[Technical Report: Performance and baseline evaluations of gpt-oss-safeguard-120b and gpt-oss-safeguard-20b](https://cdn.openai.com/pdf/08b7dee4-8bc6-4955-a219-7793fb69090c/Technical_report__Research_Preview_of_gpt_oss_safeguard.pdf)
