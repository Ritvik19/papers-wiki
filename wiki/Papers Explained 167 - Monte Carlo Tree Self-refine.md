...
Monte Carlo Tree Self-refine combines LLMs with Monte Carlo Tree Search (MCTS) to improve performance in complex mathematical reasoning tasks.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Agentic AI]], [[Reasoning Models]], [[Evaluation and Benchmarks]], [[Code Models]].
...
- I have implemented the paper using Langchain, the code is available at [GitHub](https://github.com/Ritvik19/mcts-langchain).
...
*Figure: Performance of MCTSr on the GSM Dataset.*
...
*Figure: Performance of MCTSr on the MATH Dataset*
...
*Figure: Performance of MCTSr on Olympiad-level Datasets*

*Figure: Closed-source LLM performance on mathematical datasets*
...
Accessing GPT-4 level Mathematical Olympiad Solutions via Monte Carlo Tree Self-refine with LLaMa-3 8B [2406.07394](https://arxiv.org/abs/2406.07394)
