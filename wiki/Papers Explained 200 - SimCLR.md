...
- A stochastic data augmentation module transforms any given data example randomly, resulting in two correlated views of the same example, denoted ˜xi and ˜xj.
...
*Figure: SimCLR’s main learning algorithm.*
...
*Figure: Illustrations of the studied data augmentation operators.*
...
*Figure: Linear evaluation (ImageNet top-1 accuracy) under individual or composition of data augmentations, applied only to one branch.*

*Figure: Top-1 accuracy of unsupervised ResNet-50 using linear evaluation and supervised ResNet-50 , under varied color distortion strength and other data transformations.*
...
*Figure: Linear evaluation of models with varied depth and width.*
...
*Figure: Linear evaluation of representations with different projection heads g(·) and various dimensions of z = g(h).*
...
*Figure: Linear evaluation for models trained with different loss functions.*

*Figure: Linear evaluation for models trained with different choices of l2 norm and temperature τ for NT-Xent loss.*
...
*Figure: Linear evaluation models (ResNet-50) trained with different batch size and epochs.*
...
*Figure: ImageNet accuracies of linear classifiers trained on representations learned with different self-supervised methods.*
...
*Figure: ImageNet accuracy of models trained with few labels.*
...
*Figure: Comparison of transfer learning performance of the self-supervised approach with supervised baselines across 12 natural image classification datasets.*
...
A Simple Framework for Contrastive Learning of Visual Representations [2002.05709](https://arxiv.org/abs/2002.05709)
