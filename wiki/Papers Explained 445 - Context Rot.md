...
LLMs are typically presumed to process context uniformly. However, in practice, this assumption does not hold. Model performance varies significantly as input length changes, even on simple tasks.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Long Context]], [[Large Language Models]], [[Evaluation and Benchmarks]], [[Embedding and Retrieval]], [[Document AI]].
...
- However, NIAH is fundamentally a simple retrieval task, in which a known sentence (the “needle”) is placed in a long document of unrelated text (the “haystack”), and the model is prompted to retrieve it.
...
*Figure: Example Needle in a Haystack (NIAH) Setup*
...
*Figure: Comparison — Distractor vs. Irrelevant Context*
...
*Figure: NIAH: Needle-Question Similarity.*
...
*Figure: Impact of Distractors — Three Conditions*

*Figure: Impact of Distractors: Performance by Number of Distractors — arXiv haystack/PG essay needles*
...
*Figure: Impact of Distractors: Performance by Individual Distractors — arXiv haystack/PG essay needles*
...
*Figure: Impact of Distractors: Failure Analysis — arXiv haystack/PG essay needles*
...
*Figure: Needle-Haystack Similarity: Experimental Setup*

*Figure: Needle-Haystack Similarity Results*
...
*Figure: Haystack Structure: Sample Experimental Setup*

*Figure: Haystack Structure: Averaged Performance Across 18 Models for Original vs Shuffled Haystacks*
...
*Figure: LongMemEval — Examples by Question Type*

*Figure: LongMemEval Results — Claude Family*

*Figure: LongMemEval Results — GPT Family*

*Figure: LongMemEval Results — Gemini Family*

*Figure: LongMemEval Results — Qwen Family*
...
[[Papers Explained: Is Grep All You Need]] extends this LongMemEval thread from direct long-context reading into agentic retrieval. Instead of giving the model focused versus full prompts, it lets agents retrieve from multi-session histories with grep or vector search, showing that the retrieval tool, result-delivery format, and [[Agent Harness]] can change accuracy as much as the underlying model.
...
*Figure: Repeated Words — Claude Family*

*Figure: Repeated Words — GPT Family*

*Figure: Repeated Words — Gemini Family*

*Figure: Repeated Words — Qwen Family*
