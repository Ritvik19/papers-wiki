...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Agentic AI]], [[Large Language Models]], [[Synthetic Data]], [[Reasoning Models]].
...
- Current approaches assume that more data yields better agency, following traditional scaling laws from language modeling. LIMI (Less Is More for Intelligent Agency) demonstrates that agency follows radically different development principles.
- The [dataset](https://huggingface.co/datasets/GAIR/LIMI) and [model](https://huggingface.co/GAIR/LIMI) are available at HuggingFace.
- The development of agentic intelligence is primarily tested through complex, multi-step challenges referred to as “long-horizon tasks.” These tasks require sustained cognitive effort and strategic coordination over extended interaction sequences.
...
*Figure: An example of the user query.*
...
*Figure: LIMI Data Construction Pipeline.*
...
*Figure: Agency Bench Task Overview.*
...
*Figure: Comparison of models on AgencyBench.*
...
*Figure: Performance comparison across generalization benchmarks.*
...
*Figure: Performance comparison on generalization benchmarks without CLI environment access.*
...
LIMI: Less is More for Agency [2509.17567](https://arxiv.org/abs/2509.17567)
