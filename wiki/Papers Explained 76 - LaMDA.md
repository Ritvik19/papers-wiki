...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Large Language Models]], [[Safety and Alignment]], [[Evaluation and Benchmarks]], [[Supervised Fine-Tuning]].
...
*Figure: LaMDA pre-training as a language model*
...
*Figure: Hyper-parameters for pre-training 2B, 8B and 137B models. All models were trained with 256K tokens per batch.*
...
*Figure: Summary of the datasets to improve safety, groundedness, and quality*
...
*Figure: Results for Foundation Metrics*

*Figure: Effects of model scaling and fine-tuning on six foundation metrics.*
...
*Figure: The two domains we experiment with LaMDA for domain grounding*
...
LaMDA: Language Models for Dialog Applications [2201.08239](https://arxiv.org/abs/2201.08239)
