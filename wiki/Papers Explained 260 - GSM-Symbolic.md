...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Evaluation and Benchmarks]], [[Reasoning Models]], [[Large Language Models]], [[Synthetic Data]], [[Model Compression and Efficiency]].
...
- This research investigates the true mathematical reasoning abilities of LLMs by addressing concerns about the reliability of existing benchmarks like GSM8K.
...
- Susceptibility to Irrelevant Information: Adding a seemingly relevant but ultimately unnecessary clause to a question causes a significant performance drop (up to 65%) across all tested models.
...
*Figure: Illustration of the GSM-Symbolic template creation process.*
...
*Figure: The distribution of 8-shot Chain-of-Thought (CoT) performance across 50 sets generated from GSM-Symbolic templates.*
...
*Figure: The performance of all state-of-the-art models on GSM-Symbolic.*
...
*Figure: How sensitive are LLMs when only names, only proper numbers, or both names and numbers are changed?*
...
*Figure: Modifying the difficulty level of GSM-Symbolic by modifying the number of clauses.*

*Figure: The impact of increasing the number of clauses on performance.*
...
*Figure: An example from the GSM-NoOp dataset.*

*Figure: The performance of models drops significantly on GSM-NoOp.*
...
GSM-Symbolic: Understanding the Limitations of Mathematical Reasoning in Large Language Models [2410.05229](https://arxiv.org/abs/2410.05229)
