...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Evaluation and Benchmarks]], [[Large Language Models]], [[Vision Language Models]], [[Agentic AI]].
...
- The FACTS Leaderboard is an online leaderboard suite and associated set of benchmarks that comprehensively evaluates the ability of language models to generate factually accurate text across diverse scenarios.
...
To mitigate overfitting, only a subset of the prompts will be released publicly, and the remaining prompts will remain private. All model evaluation will be conducted by [Kaggle](https://www.kaggle.com/benchmarks/google/facts/).

*Figure: Main results on the FACTS benchmark suite.*
...
*Figure: Distributions of image and question categories in the FACTS Multimodal benchmark.*
...
*Figure: Detailed results on the FACTS Multimodal benchmark.*
...
*Figure: Distributions of context domain and of answer type as a percent of the total set of questions in the FACTS Parametric benchmark.*
...
*Figure: Detailed results on the FACTS Parametric benchmark.*
...
*Figure: Detailed results on the FACTS Search benchmark.*
...
*Figure: Distributions of context domain and of task requested by the user as a percent of the total set of prompts in the benchmark.*
...
The FACTS Leaderboard: A Comprehensive Benchmark for Large Language Model Factuality [2512.10791](https://arxiv.org/abs/2512.10791)
