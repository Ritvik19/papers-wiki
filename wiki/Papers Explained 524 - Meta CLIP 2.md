...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Vision Language Models]], [[Synthetic Data]], [[Multilingual Models]].
...
- A from-scratch, worldwide CLIP training recipe that extends Meta CLIP’s English-only data curation to 300+ languages using Wikipedia and multilingual WordNet, with per-language substring matching and balancing to create a controlled, concept-balanced training...
...
*Figure: Overview of Meta CLIP 2 recipe.*
...
*Figure: Hyperparameters of OpenAI CLIP / Meta CLIP vs Meta CLIP 2.*

## Evaluation

*Figure: Main ablation.*
...
*Figure: Ablation study of metadata and alt-texts combination on ViT-B/32.*
...
*Figure: Ablation study of various multilingual tokenizers with ViT-B/32 and Worldwide 1.0×.*
...
Meta CLIP 2: A Worldwide Scaling Recipe [2507.22062](https://arxiv.org/abs/2507.22062)
