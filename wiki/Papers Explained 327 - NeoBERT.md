...
- Positional Information: NeoBERT, like all newer encoders, integrates RoPE. Nevertheless, degradation still occurs with sequences significantly longer than those seen during training.
...
- Ablation studies are conducted to evaluate improvements to the original BERT architecture. Ten models (M0-M10) are created with iterative modifications, evaluated on GLUE.
...
*Figure: Comparison of Model Architectures, Training Data, and Pre-Training Configurations.*
...
*Figure: Modifications between successive ablations.*
...
*Figure: GLUE ablation scores on the development set.*
...
*Figure: GLUE scores on the development set.*
...
*Figure: MTEB scores on the English subset after 2,000 steps of fine-tuning with contrastive learning.*
...
*Figure: Pseudo-Perplexity in function of the sequence length.*
...
*Figure: Model throughput (tokens per second) as a function of sequence length (↑ is better).*
...
NeoBERT: A Next-Generation BERT [2502.19587](https://arxiv.org/abs/2502.19587)
