...
- Source file: `raw/2025-06-11_Papers-Explained-385--J1-8245b6ee64df.md`
...
Figures from the Medium HTML export (`raw/2025-06-11_Papers-Explained-385--J1-8245b6ee64df.md`); local copies under `wiki/assets/papers-explained-385-j1/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-385-j1/fig-1.webp) | Title card: J1. |
| ![Figure 2](assets/papers-explained-385-j1/fig-2.webp) | Reinforcement Learning recipes for training Pairwise-J1 and Pointwise-J1 models. |
| ![Figure 3](assets/papers-explained-385-j1/fig-3.webp) | Results on PPE. |
| ![Figure 4](assets/papers-explained-385-j1/fig-4.webp) | Results on five reward modeling benchmarks. |
| ![Figure 5](assets/papers-explained-385-j1/fig-5.webp) | Results on RewardBench. |
| ![Figure 6](assets/papers-explained-385-j1/fig-6.webp) | Results on PPE Correctness and JudgeBench. |
| ![Figure 7](assets/papers-explained-385-j1/fig-7.webp) | Test-time scaling of Pairwise-J1 and Pointwise-J1 on the PPE Correctness benchmark. |
| ![Figure 8](assets/papers-explained-385-j1/fig-8.webp) | Results of Pairwise-J1 models trained with different reward schemes and seed prompts. |
| ![Figure 9](assets/papers-explained-385-j1/fig-9.webp) | Distribution of Absolute Scores and ∆Score (Chosen − Rejected) generated by the 8B Pairwise-J1 (w/ Scores) and Pointwise-J1 models on the PPE Correctness benchmark. |
| ![Figure 10](assets/papers-explained-385-j1/fig-10.webp) | Reward and average generation length during training for different J1-Llama-8B models. |
## Related
