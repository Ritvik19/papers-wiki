...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Computer Vision]], [[Large Language Models]], [[Multilingual Models]], [[Supervised Fine-Tuning]].
...
- Swin Transformer v2 explores large-scale models in computer vision, addressing challenges like training stability, resolution gaps, and labeled data scarcity.
- The main idea of Swin Transformer is to introduce several important visual priors into the vanilla Transformer encoder, including hierarchy, locality, and translation invariance, which combines the strength of both: the basic Transformer unit has strong...
...
- The original Swin Transformer employs a relative position bias term in self-attention calculations to capture spatial relationships between visual elements, using a parametric bias matrix B to adjust attention scores.
...
*Figure: Swin Transformer V/S Swin Transformer V2*
...
*Figure: Comparison on ImageNet-1K V1 and V2 classification. * indicates the sparse models.*
...
*Figure: Comparison on COCO object detection and instance segmentation.*
...
*Figure: Comparison on ADE20K semantic segmentation. * indicates multi-scale testing is used*
...
*Figure: Comparison on Kinetics-400 video action classification.*
...
Swin Transformer V2: Scaling Up Capacity and Resolution [2111.09883](https://arxiv.org/abs/2111.09883)
