...
The project is available at [GitHub](https://github.com/ceodspspectrum/oeis-sequence-benchmark/).

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Code Models]], [[Evaluation and Benchmarks]], [[Reasoning Models]], [[Large Language Models]], [[Document AI]].
...
*Figure: Workflow for curating the OEIS-based benchmark dataset.*
...
*Figure: Distribution of scores for the top three reasoning and non-reasoning models.*
...
Benchmarking Large Language Models with Integer Sequence Generation Tasks [2411.04372](https://arxiv.org/abs/2411.04372)
