...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Large Language Models]], [[Reinforcement Learning Topic]], [[Code Models]], [[Synthetic Data]], [[Supervised Fine-Tuning]].
...
*Figure: The evaluation metrics of the core TÜLU-2 suite and its peers.*
...
*Figure: Results of LLAMA-2 models finetuned on the V1 and V2 data mixtures, and ShareGPT.*
...
*Figure: Evaluation results for TÜLU V2 models with and without DPO finetuning.*

*Figure: MT-Bench and AlpacaEval results, along with average output length of AlpacaEval responses.*
...
*Figure: Results from LLAMA-2 models finetuned with and without QLoRA on the V2 mix.*
...
*Figure: Evaluation results comparing models based on Code LLAMA with the TÜLU models.*
...
Camels in a Changing Climate: Enhancing LM Adaptation with Tulu 2 [2311.10702](https://arxiv.org/abs/2311.10702)
