...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Safety and Alignment]], [[Reinforcement Learning Topic]], [[Reasoning Models]], [[Large Language Models]], [[Reinforcement Learning]].
...
- QLAIGN is a test-time alignment method that uses Markov Chain Monte Carlo (MCMC) sampling to generate a sequence of increasingly aligned text samples, guided by a reward model.
...
*Figure: Average accuracy vs. floating point operations (FLOPS) in log scale.*
...
*Figure: Overview of the results on general alignment.*

*Figure: Average error rate as a function of inference-time floating point operations (FLOPS) in log scale.*
...
Sample, Don’t Search: Rethinking Test-Time Alignment for Language Models [2504.03790](https://arxiv.org/abs/2504.03790)
