...
AdaptiVocab is an end-to-end approach for vocabulary adaptation, designed to enhance LLM efficiency in low- resource domains.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Large Language Models]], [[Model Compression and Efficiency]], [[Embedding and Retrieval]].
...
*Figure: The AdaptiVocab pipeline*
...
*Figure: Tokenization before and after vocabulary adaptation to the History of Physics domain.*
...
*Figure: Multiple-choice QA performance.*
...
AdaptiVocab: Enhancing LLM Efficiency in Focused Domains through Lightweight Vocabulary Adaptation [2503.19693](https://arxiv.org/abs/2503.19693)
