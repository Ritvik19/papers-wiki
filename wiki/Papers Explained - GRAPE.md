...
GRAPE is a novel SFT framework that accounts for the unique characteristics of the target model. For each instruction, it gathers responses from various LLMs, and selects the one with the highest probability measured by the target model, indicating that it aligns most closely to the target model’s pretrained distribution;

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Code Models]], [[Supervised Fine-Tuning]].
...
- GRAPE is a novel SFT framework that accounts for the unique characteristics of the target model.
...
*Figure: Result of synthetic experiment on UltraInteract-SFT.*
...
*Figure: GRAPE on the Tulu-Olmo collection.*
...
The Best Instruction-Tuning Data are Those That Fit [2502.04194](https://arxiv.org/abs/2502.04194)
