...
- Source file: `raw/2023-02-09_Papers-Explained-27--BEiT-b8c225496c01.md`
...
Figures from the Medium HTML export (`raw/2023-02-09_Papers-Explained-27--BEiT-b8c225496c01.md`); local copies under `wiki/assets/papers-explained-27-beit/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-27-beit/fig-1.webp) | Title card: BEiT. |
| ![Figure 2](assets/papers-explained-27-beit/fig-2.webp) | It is challenging to directly apply BERTstyle pre-training for image data. |
## Related
