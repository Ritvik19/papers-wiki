...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Computer Vision]], [[Reasoning Models]], [[Large Language Models]], [[Embedding and Retrieval]].
...
- Segment Anything Model 2 (SAM 2) is a foundation model designed to solve promptable visual segmentation in images and videos. The model is a simple transformer architecture with streaming memory for real-time video processing.
...
- The project is available at [GitHub](https://github.com/facebookresearch/segment-anything-2/).
- Recommended Reading [Papers Explained 238: Segment Anything Model](https://ritvik19.medium.com/papers-explained-238-segment-anything-model-b3960b569fce)
...
*Figure: An illustration of the Promptable Visual Segmentation task (PVS).*
...
*Figure: Mask decoder architecture.*
...
*Figure: Comparison of our datasets with open source VOS datasets in terms of number of videos, duration, number of masklets, masks, frames, and disappearance rate.*

## Training Details

*Figure: Hyperparameters and details of SAM 2 pre-training and full training.*
...
*Figure: Zero-shot accuracy over 9 datasets in interactive offline and online evaluation settings.*
...
*Figure: Zero-shot accuracy across 17 video datasets under semi-supervised VOS evaluation using different prompts.*

- SAM 2 outperforms both XMem++ and Cutie on 17 datasets across various input prompts (click, box, mask).

### Image tasks

*Figure: Zero-shot accuracy on the Segment Anything (SA) task across 37 datasets.*
...
*Figure: Zero-shot performance on the Segment Anything (SA) task across a suite of 37 datasets.*
...
*Figure: VOS comparison to prior work.*
