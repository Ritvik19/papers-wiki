...
Inspired by the approach of evaluating LMs with LMs, this work proposes to evaluate VLMs with VLMs. For this purpose, a new feedback dataset called the Perception Collection is presented, encompassing 15K customized score rubrics that users might care about during assessment.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Vision Language Models]], [[Evaluation and Benchmarks]], [[Synthetic Data]], [[Large Language Models]].
...
- Inspired by the approach of evaluating LMs with LMs, this work proposes to evaluate VLMs with VLMs.
- The project is available at [GitHub](https://prometheus-eval.github.io/prometheus-vision/).
...
*Figure: The number of each component included in the Perception Collection.*
...
*Figure: Pearson Correlation between score decisions from human evaluators and score decisions.*
...
*Figure: Pairwise comparison of the quality of the language feedback generated.*
...
*Figure: Pearson, Kendall-Tau, Spearman correlation with scores sampled from GPT-4V across 3 inferences on visual instruction following benchmarks.*
...
*Figure: Pearson, Kendall-Tau, Spearman correlation with scores sampled from GPT-4V across 3 inferences on visual question answering benchmarks.*
...
*Figure: Pearson, Kendall-Tau, Spearman correlation with scores sampled from GPT-4V across 3 inferences on captioning benchmarks.*
...
Prometheus-Vision: Vision-Language Model as a Judge for Fine-Grained Evaluation [2401.06591](https://arxiv.org/abs/2401.06591)
