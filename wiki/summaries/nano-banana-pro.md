...
| Figure | Caption |
|--------|---------|
| ![Text-to-image benchmark bar chart](../assets/nano-banana-pro/fig-1.webp) | Gemini 3 Pro Image text-to-image benchmark scores vs leading competitors (developer blog). |
| ![Flash vs Pro comparison table](../assets/nano-banana-pro/fig-2.webp) | Speed, quality, and cost comparison: Gemini 2.5 Flash Image vs Gemini 3 Pro Image. |
