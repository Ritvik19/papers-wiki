...
**Source**: `raw/2022-04-15-data-gen/full-article.html` (128 KB HTML), `raw/2022-04-15-data-gen/full-article.md` (Markdown sibling)  
...
![EDA performance on small training sets](../assets/2022-04-15-data-gen/fig-01.png)
...
|--------|---------|---------|
| ![fig-01](../assets/2022-04-15-data-gen/fig-01.png) | EDA text augmentation improves classification on small training sets (Wei & Zou 2019). | Text augmentation |
| ![fig-02](../assets/2022-04-15-data-gen/fig-02.png) | GPT-3 + active learning human-in-the-loop labeling pipeline (Wang et al. 2021). | LM as annotator |
| ![fig-03](../assets/2022-04-15-data-gen/fig-03.png) | GPT-3 labeling vs human cost curve on classification (Wang et al. 2021). | LM as annotator |
| ![fig-04](../assets/2022-04-15-data-gen/fig-04.png) | LAMBADA LM-based data augmentation framework (Anaby-Tavor et al. 2019). | LAMBADA |
| ![fig-05](../assets/2022-04-15-data-gen/fig-05.png) | UDG unsupervised data generation via few-shot prompting (Wang et al. 2021). | UDG |
| ![fig-06](../assets/2022-04-15-data-gen/fig-06.png) | UDG accuracy vs few-shot and supervised baselines (Wang et al. 2021). | UDG |
| ![fig-07](../assets/2022-04-15-data-gen/fig-07.png) | Few-shot generation + distillation + back-translation for translation (Han et al. 2021). | Translation synthesis |
| ![fig-08](../assets/2022-04-15-data-gen/fig-08.png) | BLEU scores: distillation vs back-translation combinations (Han et al. 2021). | Translation synthesis |
| ![fig-09](../assets/2022-04-15-data-gen/fig-09.png) | Affinity vs diversity scatter plot for augmentation quality (Gontijo-Lopes et al. 2020). | Data quality metrics |
| ![fig-10](../assets/2022-04-15-data-gen/fig-10.png) | Noise adaptation layer $Q$ between softmax and loss (Sukhbaatar et al. 2015). | Noisy training |
| ![fig-11](../assets/2022-04-15-data-gen/fig-11.png) | Gold loss correction (GLC) noise matrix estimation (Hendrycks et al. 2018). | Label correction |
| ![fig-12](../assets/2022-04-15-data-gen/fig-12.png) | Learning to reweight (L2R) meta-gradient sample weights (Ren et al. 2018). | Sample reweighting |
| ![fig-13](../assets/2022-04-15-data-gen/fig-13.png) | L2R experiment results on biased/noisy data (Ren et al. 2018). | Sample reweighting |
| ![fig-14](../assets/2022-04-15-data-gen/fig-14.png) | MentorNet curriculum over noisy samples (Jiang et al. 2018). | Sample reweighting |
| ![fig-15](../assets/2022-04-15-data-gen/fig-15.png) | Co-teaching: cross-network small-loss selection (Han et al. 2018). | Co-teaching |
