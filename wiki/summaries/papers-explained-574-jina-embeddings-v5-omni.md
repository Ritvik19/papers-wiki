...
**Source**: `raw/2026-06-04_Papers-Explained-574--Jina-Embeddings-v5-Omni-1a08a156e52e.html`  
...
![GELATO architecture](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-2.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-1.png) | Title card: Jina Embeddings v5 Omni. | Header |
| ![fig-2](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-2.png) | Architecture of jina-embeddings-v5-omni. | Architecture |
| ![fig-3](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-3.png) | Image input sequence construction. | Input sequence |
| ![fig-4](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-4.png) | Audio input sequence construction. | Input sequence |
| ![fig-5](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-5.png) | Video frame concatenation. | Input sequence |
| ![fig-6](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-6.png) | Video with audio track prefix. | Input sequence |
| ![fig-7](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-7.png) | InfoNCE + Matryoshka training objective. | Training |
| ![fig-8](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-8.png) | Matryoshka loss sum over prefix dimensions. | Training |
| ![fig-9](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-9.png) | Open-weight omni model scores on selected subsets. | Evaluation |
| ![fig-10](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-10.png) | ViDoRe document-retrieval scores. | Evaluation |
| ![fig-11](../assets/papers-explained-574-jina-embeddings-v5-omni/fig-11.png) | Main benchmark results table. | Evaluation |
