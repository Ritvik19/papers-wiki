...
**Source**: `raw/claude-watermarking/full-article.html`, `raw/claude-watermarking/full-article.md`  
**Ingested**: 2026-08-23  
**Tags**: #summary
...
![Figure 18: Claude text watermark overview](../assets/claude-watermarking/fig-18.png)
...
![Figure 23: Secret key and token context PRNG derivation](../assets/claude-watermarking/fig-23.png)
...
![Figure 35: Tournament sampling replacement for random choice](../assets/claude-watermarking/fig-35.png)
...
![Figure 52: Local model editing pipeline](../assets/claude-watermarking/fig-52.png)
...
| Figure | Caption | File |
|--------|---------|------|
| ![fig-3](../assets/claude-watermarking/fig-3.png) | Anthropic announcement about Claude text watermarking | `wiki/assets/claude-watermarking/fig-3.png` |
| ![fig-9](../assets/claude-watermarking/fig-9.png) | Step 3: obtain next-token score distribution from LLM | `wiki/assets/claude-watermarking/fig-9.png` |
| ![fig-15](../assets/claude-watermarking/fig-15.png) | Softmax conversion of logits into probabilities | `wiki/assets/claude-watermarking/fig-15.png` |
| ![fig-18](../assets/claude-watermarking/fig-18.png) | Anthropic's explanation of Claude's text watermark | `wiki/assets/claude-watermarking/fig-18.png` |
| ![fig-23](../assets/claude-watermarking/fig-23.png) | Deriving pseudorandom seeds from secret key and token context | `wiki/assets/claude-watermarking/fig-23.png` |
| ![fig-27](../assets/claude-watermarking/fig-27.png) | Text generation lifecycle with vs. without watermarking | `wiki/assets/claude-watermarking/fig-27.png` |
| ![fig-28](../assets/claude-watermarking/fig-28.png) | Watermark detection requiring secret key and hashing functions | `wiki/assets/claude-watermarking/fig-28.png` |
| ![fig-32](../assets/claude-watermarking/fig-32.png) | Modified sampling stage enabling lightweight downstream scoring | `wiki/assets/claude-watermarking/fig-32.png` |
| ![fig-35](../assets/claude-watermarking/fig-35.png) | Tournament sampling replacing ordinary weighted random choice | `wiki/assets/claude-watermarking/fig-35.png` |
| ![fig-37](../assets/claude-watermarking/fig-37.png) | Assigning bit signatures across candidate vocabulary tokens | `wiki/assets/claude-watermarking/fig-37.png` |
| ![fig-40](../assets/claude-watermarking/fig-40.png) | Tournament knockout rounds determining winning token | `wiki/assets/claude-watermarking/fig-40.png` |
| ![fig-44](../assets/claude-watermarking/fig-44.png) | Comparing average watermark bit scores between watermarked and unwatermarked text | `wiki/assets/claude-watermarking/fig-44.png` |
| ![fig-45](../assets/claude-watermarking/fig-45.png) | Threshold decision boundary classifying text as watermarked | `wiki/assets/claude-watermarking/fig-45.png` |
| ![fig-50](../assets/claude-watermarking/fig-50.png) | Multi-position editing required to disrupt watermark detection | `wiki/assets/claude-watermarking/fig-50.png` |
| ![fig-52](../assets/claude-watermarking/fig-52.png) | Local model paraphrasing pipeline and text quality degradation | `wiki/assets/claude-watermarking/fig-52.png` |
