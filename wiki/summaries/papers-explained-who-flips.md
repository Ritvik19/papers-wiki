...
**Source**: `raw/2026-08-30_Papers-Explained--Who-Flips--a826d55d4acf.html`  
...
![Papers Explained: Who Flips banner](../assets/papers-explained-who-flips/fig-1.png)
...
![AFRblind by model and argument length k](../assets/papers-explained-who-flips/fig-3.png)
...
![Subject-level AFR vs coercion success rate](../assets/papers-explained-who-flips/fig-6.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-who-flips/fig-1.png) | Overview banner for Papers Explained: Who Flips? | Banner |
| ![fig-2](../assets/papers-explained-who-flips/fig-2.png) | Models evaluated in the study across open-weight and frontier proprietary families. | Setup |
| ![fig-3](../assets/papers-explained-who-flips/fig-3.png) | Answer Flip Rate under blind attribution ($AFR_{BLIND}$) across models and argument lengths $k \in \{2, 5, 10\}$. | Results |
| ![fig-4](../assets/papers-explained-who-flips/fig-4.png) | Self-Attribution Delta ($SAD(k) = AFR_{SELF}(k) - AFR_{BLIND}(k)$) showing positive flip increase for all models. | Self-Attribution |
| ![fig-5](../assets/papers-explained-who-flips/fig-5.png) | Subject-level AFR averaged across models, argument lengths $k$, and attribution conditions across MMLU domains. | Domain Analysis |
| ![fig-6](../assets/papers-explained-who-flips/fig-6.png) | Subject-level AFR vs. Coercion Success Rate (CSR), demonstrating a strong positive relationship across subjects. | CSR vs AFR |
| ![fig-7](../assets/papers-explained-who-flips/fig-7.png) | Comparison between self-generated arguments ($AFR_{BLIND}$) and peer-generated arguments ($AFR_{CROSS}$). | Cross-Model |
| ![fig-8](../assets/papers-explained-who-flips/fig-8.png) | Answer Flip Rate under standard self-generated arguments ($k=10$) vs. curated multi-model arguments ([[MAXFLIP]]). | MAXFLIP |
