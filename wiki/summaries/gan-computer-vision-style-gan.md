...
**Source**: `raw/gan-computer-vision-style-gan/full-article.html`, `raw/gan-computer-vision-style-gan/full-article.md` (markdown view)  
...
![Rotation self-supervision: D predicts applied rotation on real images](../assets/gan-computer-vision-style-gan/fig-1.png)
...
![StyleGAN generator: mapping network, AdaIN style blocks, noise injection](../assets/gan-computer-vision-style-gan/fig-5.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/gan-computer-vision-style-gan/fig-1.png) | Self-supervised rotation baseline: 4 rotations per image (Gidaris et al.) | — |
| ![fig-2](../assets/gan-computer-vision-style-gan/fig-2.png) | D forgetting: unconditional GAN classifier accuracy drops after 500k iters | — |
| ![fig-3](../assets/gan-computer-vision-style-gan/fig-3.png) | Self-supervised GAN ImageNet 128×128 samples | — |
| ![fig-4](../assets/gan-computer-vision-style-gan/fig-4.png) | AdaIN encoder–decoder style transfer architecture and results | — |
| ![fig-5](../assets/gan-computer-vision-style-gan/fig-5.png) | StyleGAN style-based generator overview | — |
| ![fig-6](../assets/gan-computer-vision-style-gan/fig-6.png) | StyleGAN truncation in W space: attribute flips at ψ→0 | — |
| ![fig-7](../assets/gan-computer-vision-style-gan/fig-7.png) | Localized noise injection: regional std-dev maps | — |
| ![fig-8](../assets/gan-computer-vision-style-gan/fig-8.png) | Linear separability metric: StyleGAN W vs Z vs Progressive GAN | — |
