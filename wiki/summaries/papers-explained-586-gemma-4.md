...
**Source**: `raw/2026-08-03_Papers-Explained--Gemma-4-ba2108a444a9.md`  
...
![Parameter counts for the Gemma 4 models](../assets/papers-explained-586-gemma-4/fig-2.webp)
...
![Vision encoder architecture](../assets/papers-explained-586-gemma-4/fig-3.webp)
...
![The autoregressive MTP drafter](../assets/papers-explained-586-gemma-4/fig-6.webp)
...
![Performance comparison](../assets/papers-explained-586-gemma-4/fig-9.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-586-gemma-4/fig-1.webp) | Papers Explained 586: Gemma 4 banner. | Overview |
| ![fig-2](../assets/papers-explained-586-gemma-4/fig-2.webp) | Parameter counts for the Gemma 4 models. | Architecture |
| ![fig-3](../assets/papers-explained-586-gemma-4/fig-3.webp) | Vision encoder architecture. | Modality |
| ![fig-4](../assets/papers-explained-586-gemma-4/fig-4.webp) | Image resizing. | Modality |
| ![fig-5](../assets/papers-explained-586-gemma-4/fig-5.webp) | Aspect-Ratio Preserving Image Resizing procedure. | Modality |
| ![fig-6](../assets/papers-explained-586-gemma-4/fig-6.webp) | The autoregressive MTP drafter. | Decoding |
| ![fig-7](../assets/papers-explained-586-gemma-4/fig-7.webp) | Formatting for Gemma IT models. | Post-Training |
| ![fig-8](../assets/papers-explained-586-gemma-4/fig-8.webp) | Leading open-weight models on Arena Text. | Evaluation |
| ![fig-9](../assets/papers-explained-586-gemma-4/fig-9.webp) | Performance comparison of Gemma 3 27B and Gemma 4 models on diverse benchmarks. | Evaluation |
| ![fig-10](../assets/papers-explained-586-gemma-4/fig-10.webp) | Gemma 4 models performance on vision benchmarks at different resolutions. | Evaluation |
| ![fig-11](../assets/papers-explained-586-gemma-4/fig-11.webp) | Audio performance for Gemma 4 and Gemma 3n models. | Evaluation |
| ![fig-12](../assets/papers-explained-586-gemma-4/fig-12.webp) | Audio performance of Gemma 4 12B model on supported languages. | Evaluation |
| ![fig-13](../assets/papers-explained-586-gemma-4/fig-13.webp) | Long context performance of Gemma 3 and Gemma 4 models. | Evaluation |
