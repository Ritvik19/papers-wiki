...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/gemini-3-1-pro/fig-1.gif) | Side-by-side benchmark comparison across reasoning and capability evals | — |

![Benchmark comparison across AI models](../assets/gemini-3-1-pro/fig-1.gif)
