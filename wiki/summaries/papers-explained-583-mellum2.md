...
**Source**: `raw/draft_Papers-Explained-583--Mellum2-7c59fdbfb6e6.html`  
...
![Mellum 2 architecture](../assets/papers-explained-583-mellum2/fig-1.png)
...
![Post-training instruct evaluation](../assets/papers-explained-583-mellum2/fig-9.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-583-mellum2/fig-1.png) | Architecture configuration of Mellum 2. | Architecture |
| ![fig-2](../assets/papers-explained-583-mellum2/fig-2.png) | Three-phase pre-training curriculum. | Pre-training |
| ![fig-3](../assets/papers-explained-583-mellum2/fig-3.png) | Training schedule. | Pre-training |
| ![fig-4](../assets/papers-explained-583-mellum2/fig-4.png) | Optimizer and training hyperparameters. | Pre-training |
| ![fig-5](../assets/papers-explained-583-mellum2/fig-5.png) | Supervised fine-tuning configuration. | Post-training |
| ![fig-6](../assets/papers-explained-583-mellum2/fig-6.png) | Per-stage RL hyperparameters. | Post-training |
| ![fig-7](../assets/papers-explained-583-mellum2/fig-7.png) | RL data mix by capability domain. | Post-training |
| ![fig-8](../assets/papers-explained-583-mellum2/fig-8.png) | Pre-training evaluation results. | Evaluation |
| ![fig-9](../assets/papers-explained-583-mellum2/fig-9.png) | Post-training instruct evaluation. | Evaluation |
| ![fig-10](../assets/papers-explained-583-mellum2/fig-10.png) | Post-training thinking/reasoning evaluation. | Evaluation |
| ![fig-11](../assets/papers-explained-583-mellum2/fig-11.png) | Safety and refusal benchmarks. | Evaluation |
| ![fig-12](../assets/papers-explained-583-mellum2/fig-12.png) | JetBrains internal pairwise win rates. | Evaluation |
| ![fig-13](../assets/papers-explained-583-mellum2/fig-13.png) | Long-context extension results. | Evaluation |
