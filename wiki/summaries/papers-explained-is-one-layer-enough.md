...
**Source**: `raw/draft_Papers-Explained--Is-One-Layer-Enough-36b5241b379b.html`  
...
![Papers Explained Is One Layer Enough banner](../assets/papers-explained-is-one-layer-enough/fig-1.png)
...
![Single Layer Contribution Curves and LALR Performance](../assets/papers-explained-is-one-layer-enough/fig-7.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-is-one-layer-enough/fig-1.png) | Overview banner. | Overview |
| ![fig-2](../assets/papers-explained-is-one-layer-enough/fig-2.png) | Experimental setup across Qwen3 and Llama model families. | Setup |
| ![fig-3](../assets/papers-explained-is-one-layer-enough/fig-3.png) | Single-layer training contribution across all layers on MATH. | Analysis |
| ![fig-4](../assets/papers-explained-is-one-layer-enough/fig-4.png) | Layer contribution consistency across GSM8K, Olympiad, and Codeforces. | Analysis |
| ![fig-5](../assets/papers-explained-is-one-layer-enough/fig-5.png) | Comparison across RLVR (GRPO) and SFT training algorithms. | Comparison |
| ![fig-6](../assets/papers-explained-is-one-layer-enough/fig-6.png) | Layer-Adaptive Learning Rate (LALR) formulation and schedule. | Method |
| ![fig-7](../assets/papers-explained-is-one-layer-enough/fig-7.png) | Full-parameter training acceleration with LALR. | Results |
| ![fig-8](../assets/papers-explained-is-one-layer-enough/fig-8.png) | Layer-Selective Training (LST) compute vs. accuracy Pareto curve. | Efficiency |
| ![fig-9](../assets/papers-explained-is-one-layer-enough/fig-9.png) | Heuristic layer selection guidelines for arbitrary model depths. | Heuristics |
| ![fig-10](../assets/papers-explained-is-one-layer-enough/fig-10.png) | Representational drift and weight delta analysis across layers. | Analysis |
| ![fig-11](../assets/papers-explained-is-one-layer-enough/fig-11.png) | Cross-architecture validation on Gemma and Mistral. | Generalization |
| ![fig-12](../assets/papers-explained-is-one-layer-enough/fig-12.png) | Memory savings during single-layer and selective-layer backpropagation. | Efficiency |
| ![fig-13](../assets/papers-explained-is-one-layer-enough/fig-13.png) | Gradient norm distribution across transformer depth. | Dynamics |
| ![fig-14](../assets/papers-explained-is-one-layer-enough/fig-14.png) | Qualitative reasoning trace changes under middle-layer training. | Qualitative |
| ![fig-15](../assets/papers-explained-is-one-layer-enough/fig-15.png) | Comparison against LoRA rank scaling across depth. | Comparison |
| ![fig-16](../assets/papers-explained-is-one-layer-enough/fig-16.png) | Synthesis of layer contribution principles for post-training. | Summary |
