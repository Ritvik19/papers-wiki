...
**Source**: `raw/draft_Papers-Explained-576--Aryabhata-2-9d3d23738731.md`  
...
![Dataset preprocessing pipeline](../assets/papers-explained-576-aryabhata-2/fig-2.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-576-aryabhata-2/fig-1.webp) | Title card: Aryabhata 2. | Header |
| ![fig-2](../assets/papers-explained-576-aryabhata-2/fig-2.webp) | Dataset distribution across preprocessing stages. | Data |
| ![fig-3](../assets/papers-explained-576-aryabhata-2/fig-3.webp) | Format reward length component. | RL reward |
| ![fig-4](../assets/papers-explained-576-aryabhata-2/fig-4.webp) | Format reward formula. | RL reward |
| ![fig-5](../assets/papers-explained-576-aryabhata-2/fig-5.webp) | S_len and S_ratio definitions. | RL reward |
| ![fig-6](../assets/papers-explained-576-aryabhata-2/fig-6.webp) | RL hyperparameters across three phases. | Training |
| ![fig-7](../assets/papers-explained-576-aryabhata-2/fig-7.webp) | In-distribution Pass@1 overall accuracy. | Evaluation |
| ![fig-8](../assets/papers-explained-576-aryabhata-2/fig-8.webp) | In-distribution accuracy–token trade-off. | Evaluation |
| ![fig-9](../assets/papers-explained-576-aryabhata-2/fig-9.webp) | Out-of-distribution Pass@1 accuracy. | Evaluation |
| ![fig-10](../assets/papers-explained-576-aryabhata-2/fig-10.webp) | OOD accuracy–token trade-off. | Evaluation |
