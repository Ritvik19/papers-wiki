...
**Source**: `raw/draft_Papers-Explained--Subproblem-Curriculum-Reinforcement-Learning--SCRL--c1d94c6f3b00.md`  
...
![Papers Explained SCRL banner](../assets/papers-explained-scrl/fig-1.webp)
...
![SCRL Subproblem Graph and Reward Flow](../assets/papers-explained-scrl/fig-2.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-scrl/fig-1.webp) | SCRL overview banner. | Overview |
| ![fig-2](../assets/papers-explained-scrl/fig-2.webp) | Subproblem DAG decomposition and curriculum scheduling. | Method |
| ![fig-3](../assets/papers-explained-scrl/fig-3.webp) | Progress-Aware Subproblem Reward formulation. | Method |
| ![fig-4](../assets/papers-explained-scrl/fig-4.webp) | Exploration efficiency comparison: SCRL vs Standard RLVR. | Results |
| ![fig-5](../assets/papers-explained-scrl/fig-5.webp) | Benchmark accuracy on OlympiadBench and Codeforces. | Results |
| ![fig-6](../assets/papers-explained-scrl/fig-6.webp) | Ablation of subproblem granularity and DAG depth. | Ablations |
| ![fig-7](../assets/papers-explained-scrl/fig-7.webp) | Policy entropy and milestone completion rates over training. | Dynamics |
| ![fig-8](../assets/papers-explained-scrl/fig-8.webp) | Qualitative proof decomposition example. | Qualitative |
| ![fig-9](../assets/papers-explained-scrl/fig-9.webp) | Verification failure recovery analysis. | Analysis |
| ![fig-10](../assets/papers-explained-scrl/fig-10.webp) | Cross-domain transfer on complex software bug localization. | Transfer |
