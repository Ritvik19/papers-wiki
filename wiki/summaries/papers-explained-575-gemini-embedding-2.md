...
**Source**: `raw/2026-06-05_Papers-Explained-575--Gemini-Embedding-2-a9e9ed849227.html`  
**Ingested**: 2026-06-13  
**Tags**: #summary
...
![Gemini Embedding 2 workflow](../assets/papers-explained-575-gemini-embedding-2/fig-1.png)
...
![Retrieval benchmark comparison](../assets/papers-explained-575-gemini-embedding-2/fig-4.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-575-gemini-embedding-2/fig-1.png) | Conceptual workflow: tokenize → M → P → f. | Architecture |
| ![fig-2](../assets/papers-explained-575-gemini-embedding-2/fig-2.png) | NCE loss setup with query, positive, optional hard negative. | Training |
| ![fig-3](../assets/papers-explained-575-gemini-embedding-2/fig-3.png) | Batch NCE loss formula. | Training |
| ![fig-4](../assets/papers-explained-575-gemini-embedding-2/fig-4.png) | Retrieval benchmark comparison. | Evaluation |
| ![fig-5](../assets/papers-explained-575-gemini-embedding-2/fig-5.png) | MTEB / multilingual / code / CoIR comparison. | Evaluation |
| ![fig-6](../assets/papers-explained-575-gemini-embedding-2/fig-6.png) | Label masking term for classification tasks. | Training |
| ![fig-7](../assets/papers-explained-575-gemini-embedding-2/fig-7.png) | Similarity denominator with masking. | Training |
| ![fig-8](../assets/papers-explained-575-gemini-embedding-2/fig-8.png) | MSEB passage retrieval (native audio vs ASR). | Evaluation |
