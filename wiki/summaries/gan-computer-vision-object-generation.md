...
**Source**: `raw/gan-computer-vision-object-generation/full-article.md` (399 KB), `raw/gan-computer-vision-object-generation/full-article.md` (markdown view)  
...
![AC-GAN MS-SSIM diversity vs real data (red line)](../assets/gan-computer-vision-object-generation/fig-1.webp)
...
![3D-GAN volumetric generator architecture](../assets/gan-computer-vision-object-generation/fig-4.webp)
...
![Pix2Pix PatchGAN: L1 captures low frequencies, adversarial loss refines high-frequency structure](../assets/gan-computer-vision-object-generation/fig-8.webp)
...
![Cycle consistency: F(G(x)) should reconstruct x](../assets/gan-computer-vision-object-generation/fig-9.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/gan-computer-vision-object-generation/fig-1.webp) | AC-GAN: MS-SSIM similarity of generated vs real same-class images | — |
| ![fig-2](../assets/gan-computer-vision-object-generation/fig-2.webp) | AC-GAN: MS-SSIM vs inception accuracy scatter (red = real-data diversity) | — |
| ![fig-3](../assets/gan-computer-vision-object-generation/fig-3.webp) | AC-GAN latent walks: rows = same noise, different class; columns = same class, different noise | — |
| ![fig-4](../assets/gan-computer-vision-object-generation/fig-4.webp) | 3D-GAN generator: 4×4×4 conv3d blocks doubling spatial dims | — |
| ![fig-5](../assets/gan-computer-vision-object-generation/fig-5.webp) | 3D-VAE-GAN single RGB image → voxelized 3D reconstruction | — |
| ![fig-6](../assets/gan-computer-vision-object-generation/fig-6.webp) | 3D-VAE-GAN latent vector arithmetic producing semantic shape edits | — |
| ![fig-7](../assets/gan-computer-vision-object-generation/fig-7.webp) | PacGAN: packed-sample discriminator improves diversity over DCGAN | — |
| ![fig-8](../assets/gan-computer-vision-object-generation/fig-8.webp) | Pix2Pix PatchGAN results: L1 + adversarial vs ablations | — |
| ![fig-9](../assets/gan-computer-vision-object-generation/fig-9.webp) | CycleGAN cycle consistency diagram: F(G(x)) ≈ x | — |
| ![fig-10](../assets/gan-computer-vision-object-generation/fig-10.webp) | CycleGAN unpaired translation results (both directions) | — |
| ![fig-11](../assets/gan-computer-vision-object-generation/fig-11.webp) | CycleGAN vs Pix2Pix comparison on paired task (unfair but competitive) | — |
