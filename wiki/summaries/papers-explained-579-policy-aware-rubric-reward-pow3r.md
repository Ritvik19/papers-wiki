...
**Source**: `raw/draft_Papers-Explained-579--Policy-Aware-Rubric-Reward--POW3R--6fa98f57e4f9.md`  
...
![POW3R overview](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-1.webp)
...
![Main results summary](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-5.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-1.webp) | POW3R framework overview. | Method |
| ![fig-2](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-2.webp) | Category-normalized reward formula. | Method |
| ![fig-3](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-3.webp) | Pass rate and variance per criterion. | Policy-aware factors |
| ![fig-4](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-4.webp) | Category-normalized variance ratio. | Policy-aware factors |
| ![fig-5](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-5.webp) | α update and POW3R reward. | Method |
| ![fig-6](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-6.webp) | MM test + external VLM benchmarks. | Results |
| ![fig-7](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-7.webp) | HealthBench English test split. | Results |
| ![fig-8](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-8.webp) | Two-objective Pareto summary. | Results |
| ![fig-9](../assets/papers-explained-579-policy-aware-rubric-reward-pow3r/fig-9.webp) | Per-category validation trajectories. | Results |
