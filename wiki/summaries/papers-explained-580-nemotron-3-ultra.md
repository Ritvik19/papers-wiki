...
**Source**: `raw/draft_Papers-Explained--580-Nemotron-3-Ultra-2443ef0c834b.html`  
...
![Nemotron 3 Ultra layer pattern](../assets/papers-explained-580-nemotron-3-ultra/fig-1.png)
...
![Post-training pipeline](../assets/papers-explained-580-nemotron-3-ultra/fig-4.png)
...
![Evaluation suite](../assets/papers-explained-580-nemotron-3-ultra/fig-7.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-580-nemotron-3-ultra/fig-1.png) | Nemotron 3 Ultra layer pattern. | Architecture |
| ![fig-2](../assets/papers-explained-580-nemotron-3-ultra/fig-2.png) | Architecture dimensions table. | Architecture |
| ![fig-3](../assets/papers-explained-580-nemotron-3-ultra/fig-3.png) | Pre-training data mixtures (phase 1 & 2). | Data |
| ![fig-4](../assets/papers-explained-580-nemotron-3-ultra/fig-4.png) | Post-training pipeline overview. | Post-training |
| ![fig-5](../assets/papers-explained-580-nemotron-3-ultra/fig-5.png) | Two-iteration MOPD pipeline. | MOPD |
| ![fig-6](../assets/papers-explained-580-nemotron-3-ultra/fig-6.png) | MOPD distillation objective. | MOPD |
| ![fig-7](../assets/papers-explained-580-nemotron-3-ultra/fig-7.png) | Evaluation suite results. | Evaluation |
