...
**Source**: `raw/2026-08-30_Papers-Explained--SycoBench-600-25763fece8da.md`  
...
![Papers Explained: SycoBench-600 banner](../assets/papers-explained-sycobench-600/fig-1.webp)
...
![Dataset statistics](../assets/papers-explained-sycobench-600/fig-2.webp)
...
![Main results](../assets/papers-explained-sycobench-600/fig-3.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-sycobench-600/fig-1.webp) | Overview banner for Papers Explained: SycoBench-600. | Overview |
| ![fig-2](../assets/papers-explained-sycobench-600/fig-2.webp) | Dataset statistics across domains, question stems, instances, and difficulty tiers. | Dataset |
| ![fig-3](../assets/papers-explained-sycobench-600/fig-3.webp) | Main evaluation results comparing standard Accuracy, Pressure-Robust Accuracy ($PRA_{all}$), Sycophancy rates, Update rates, and Correction Selectivity across 7 LLMs. | Results |
| ![fig-4](../assets/papers-explained-sycobench-600/fig-4.webp) | Flip-to-wrong rates (%) broken down by pressure type (doubt, authority, wrong suggestion), conditioned on baseline correctness. | Pressure Analysis |
