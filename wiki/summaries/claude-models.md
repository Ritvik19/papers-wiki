...
**Source**: `raw/introducing-claude/full-article.html`
...
**Source**: `raw/claude-2/full-article.html`
...
![Claude 2 announcement](../assets/claude-2/fig-1.png)

### Claude 2.1 (Nov 2023)

**Source**: `raw/claude-2-1/full-article.html`
...
![Claude 2.1 accuracy improvements](../assets/claude-2-1/fig-2.png)

## Claude 3 Era (2024)

### Claude 3 Family (Mar 2024)

**Source**: `raw/claude-3-family/full-article.html`
...
![Claude 3 benchmark comparison](../assets/claude-3-family/fig-2.png)

### Claude 3 Haiku (Mar 2024)

**Source**: `raw/claude-3-haiku/full-article.html`
...
![Claude 3 Haiku throughput](../assets/claude-3-haiku/fig-2.png)

### Claude 3.5 Sonnet (Jun 2024)

**Source**: `raw/claude-3-5-sonnet/full-article.html`
...
![Claude 3.5 Sonnet benchmarks](../assets/claude-3-5-sonnet/fig-2.png)

### Claude 3.5 Models & Computer Use (Oct 2024)

**Source**: `raw/3-5-models-and-computer-use/full-article.html`
...
![Computer use illustration](../assets/3-5-models-and-computer-use/fig-2.png)

## Claude 3.7 & Claude 4 Era (2025)

### Claude 3.7 Sonnet (Feb 2025)

**Source**: `raw/claude-3-7-sonnet/full-article.html`
...
![Claude 3.7 SWE-bench results](../assets/claude-3-7-sonnet/fig-4.png)

### Claude 4: Opus 4 & Sonnet 4 (May 2025)

**Source**: `raw/claude-4/full-article.html`
...
![Claude 4 SWE-bench comparison](../assets/claude-4/fig-2.png)

### Claude Opus 4.1 (Aug 2025)

**Source**: `raw/claude-opus-4-1/full-article.html`
...
![Opus 4.1 coding progress](../assets/claude-opus-4-1/fig-2.png)

### Claude Sonnet 4.5 (Sep 2025)

**Source**: `raw/claude-sonnet-4-5/full-article.html`
...
![Sonnet 4.5 SWE-bench leadership](../assets/claude-sonnet-4-5/fig-2.png)

### Claude Haiku 4.5 (Oct 2025)

**Source**: `raw/claude-haiku-4-5/full-article.html`
...
![Haiku 4.5 SWE-bench vs frontier](../assets/claude-haiku-4-5/fig-2.png)

### Claude Opus 4.5 (Nov 2025)

**Source**: `raw/claude-opus-4-5/full-article.html`
...
![Opus 4.5 SWE-bench](../assets/claude-opus-4-5/fig-2.png)

## Claude 4.6+ Era (2026)

### Claude Opus 4.6 (Feb 2026)

**Source**: `raw/claude-opus-4-6/full-article.html`
...
![Opus 4.6 benchmark table](../assets/claude-opus-4-6/fig-1.png)

### Claude Sonnet 4.6 (Feb 2026)

**Source**: `raw/claude-sonnet-4-6/full-article.html`
...
![Sonnet 4.6 OSWorld progress](../assets/claude-sonnet-4-6/fig-2.png)

### Claude Opus 4.7 (Apr 2026)

**Source**: `raw/claude-opus-4-7/full-article.html`
...
![Opus 4.7 benchmark overview](../assets/claude-opus-4-7/fig-2.png)

### Claude Opus 4.8 (May 2026)

**Source**: `raw/claude-opus-4-8/full-article.html`
...
![Opus 4.8 capabilities table](../assets/claude-opus-4-8/fig-2.png)

## Claude 5 / Mythos Era (2026)

### Claude Fable 5 and Claude Mythos 5 (Jun 2026)

**Source**: `raw/claude-fable-5-mythos-5/full-article.html`, `raw/mythos/full-article.html`
...
![Fable 5 / Mythos 5 benchmark table](../assets/claude-fable-5-mythos-5/fig-2.png)

![Pokémon FireRed vision-only playthrough](../assets/claude-fable-5-mythos-5/fig-3.png)

![Protein complexes designed by Mythos 5](../assets/claude-fable-5-mythos-5/fig-7.png)

### Claude Sonnet 5 (Jun 2026)

**Source**: `raw/claude-sonnet-5/full-article.html`
...
![Sonnet 5 benchmark table](../assets/claude-sonnet-5/fig-1.png)

![Sonnet 5 BrowseComp cost-performance](../assets/claude-sonnet-5/fig-2.png)

![Sonnet 5 misaligned-behavior rates](../assets/claude-sonnet-5/fig-4.png)
...
|--------|---------|---------|
| ![fig-1](../assets/claude-3-family/fig-2.png) | Claude 3 family benchmark comparison | Claude 3 Family |
| ![fig-2](../assets/claude-3-5-sonnet/fig-2.png) | Claude 3.5 Sonnet eval chart | Claude 3.5 Sonnet |
| ![fig-3](../assets/claude-3-7-sonnet/fig-4.png) | Claude 3.7 Sonnet SWE-bench Verified | Claude 3.7 Sonnet |
| ![fig-4](../assets/claude-4/fig-2.png) | Claude 4 SWE-bench comparison | Claude 4 |
| ![fig-5](../assets/claude-opus-4-5/fig-2.png) | Opus 4.5 SWE-bench leadership | Opus 4.5 |
| ![fig-6](../assets/claude-sonnet-4-6/fig-2.png) | Sonnet 4.6 OSWorld progress | Sonnet 4.6 |
| ![fig-7](../assets/claude-opus-4-7/fig-2.png) | Opus 4.7 benchmark overview | Opus 4.7 |
| ![fig-8](../assets/claude-fable-5-mythos-5/fig-2.png) | Fable 5 / Mythos 5 benchmark comparison | Fable 5 / Mythos 5 |
| ![fig-9](../assets/claude-fable-5-mythos-5/fig-3.png) | Pokémon FireRed vision-only timelapse | Fable 5 |
| ![fig-10](../assets/claude-fable-5-mythos-5/fig-7.png) | Protein complexes designed by Mythos 5 | Mythos 5 |
| ![fig-11](../assets/mythos/fig-1.png) | Mythos 5 product-page benchmark table | Mythos 5 |
| ![fig-12](../assets/claude-sonnet-5/fig-1.png) | Sonnet 5 benchmark comparison vs. Sonnet 4.6 and Opus 4.8 | Sonnet 5 |
| ![fig-13](../assets/claude-sonnet-5/fig-2.png) | Sonnet 5 BrowseComp cost-performance at effort levels | Sonnet 5 |
| ![fig-14](../assets/claude-sonnet-5/fig-3.png) | Sonnet 5 OSWorld-Verified cost-performance at effort levels | Sonnet 5 |
| ![fig-15](../assets/claude-sonnet-5/fig-4.png) | Misaligned-behavior rates across Claude models | Sonnet 5 |
| ![fig-16](../assets/claude-sonnet-5/fig-5.png) | Firefox exploit development evaluation (partial vs. full success) | Sonnet 5 |
