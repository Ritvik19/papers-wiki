...
**Source**: `raw/gan-computer-vision-incremental-training/full-article.html` (389 KB), `raw/gan-computer-vision-incremental-training/full-article.md` (markdown view)  
...
![WGAN provides non-saturating gradients across the space vs standard GAN](../assets/gan-computer-vision-incremental-training/fig-1.png)
...
![BEGAN autoencoder-based discriminator architecture](../assets/gan-computer-vision-incremental-training/fig-3.png)
...
![Progressive GAN: symmetric G/D grown incrementally from 4×4 to 1024×1024](../assets/gan-computer-vision-incremental-training/fig-5.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/gan-computer-vision-incremental-training/fig-1.png) | WGAN critic gradients remain informative across parameter space (vs saturated standard GAN) | — |
| ![fig-2](../assets/gan-computer-vision-incremental-training/fig-2.png) | WGAN training: stable decreasing loss and improving DCGAN samples | — |
| ![fig-3](../assets/gan-computer-vision-incremental-training/fig-3.png) | BEGAN U-shaped autoencoder discriminator/generator architecture | — |
| ![fig-4](../assets/gan-computer-vision-incremental-training/fig-4.png) | BEGAN 128×128 latent interpolations (γ controls diversity vs artifacts) | — |
| ![fig-5](../assets/gan-computer-vision-incremental-training/fig-5.png) | Progressive GAN incremental architecture growth | — |
| ![fig-6](../assets/gan-computer-vision-incremental-training/fig-6.png) | Progressive GAN smooth transition between resolutions (α-blended skip) | — |
| ![fig-7](../assets/gan-computer-vision-incremental-training/fig-7.png) | Progressive GAN 1024×1024 megapixel face results | — |
