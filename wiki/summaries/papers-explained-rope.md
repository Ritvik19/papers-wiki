...
**Source**: `raw/draft_Papers-Explained--Rotary-Position-Embedding-RoPE--5797f508073f.md`  
...
![Papers Explained RoPE banner](../assets/papers-explained-rope/fig-1.webp)
...
![RoPE 2D Rotation and Matrix Computation](../assets/papers-explained-rope/fig-2.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-rope/fig-1.webp) | RoPE overview banner. | Overview |
| ![fig-2](../assets/papers-explained-rope/fig-2.webp) | 2D complex plane vector rotation geometry. | Method |
| ![fig-3](../assets/papers-explained-rope/fig-3.webp) | General d-dimensional block diagonal rotation matrix. | Method |
| ![fig-4](../assets/papers-explained-rope/fig-4.webp) | Inner product derivation showing relative distance dependence. | Theory |
| ![fig-5](../assets/papers-explained-rope/fig-5.webp) | Relative attention decay property visualization. | Analysis |
| ![fig-6](../assets/papers-explained-rope/fig-6.webp) | Benchmark evaluation across NLP tasks and translation. | Evaluation |
| ![fig-7](../assets/papers-explained-rope/fig-7.webp) | Comparison: RoPE vs Sinusoidal vs Learned Absolute vs Shaw Relative. | Comparison |
| ![fig-8](../assets/papers-explained-rope/fig-8.webp) | Long-context extrapolation behavior on synthetic tracking. | Extrapolation |
| ![fig-9](../assets/papers-explained-rope/fig-9.webp) | Base frequency scaling analysis ($b=10000$ to $500000$). | Scaling |
| ![fig-10](../assets/papers-explained-rope/fig-10.webp) | Computation speedup via chunked elementwise implementation. | Efficiency |
| ![fig-11](../assets/papers-explained-rope/fig-11.webp) | Memory footprint comparison during training. | Efficiency |
| ![fig-12](../assets/papers-explained-rope/fig-12.webp) | Attention score decay heatmaps. | Visualization |
| ![fig-13](../assets/papers-explained-rope/fig-13.webp) | Perplexity scaling with context length. | Evaluation |
| ![fig-14](../assets/papers-explained-rope/fig-14.webp) | RoPE integration with linear and kernelized attention. | Generalization |
| ![fig-15](../assets/papers-explained-rope/fig-15.webp) | Multi-head dimension rotation distribution. | Analysis |
| ![fig-16](../assets/papers-explained-rope/fig-16.webp) | Mathematical properties and norm conservation. | Theory |
| ![fig-17](../assets/papers-explained-rope/fig-17.webp) | Summary of modern LLMs adopting RoPE. | Ecosystem |
