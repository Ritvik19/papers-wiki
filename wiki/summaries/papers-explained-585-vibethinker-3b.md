...
**Source**: `raw/draft_Papers-Explained-585--VibeThinker-3B-a82a4fe1299f.html`  
...
![VibeThinker-3B training pipeline](../assets/papers-explained-585-vibethinker-3b/fig-1.png)
...
![Core benchmark results](../assets/papers-explained-585-vibethinker-3b/fig-2.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-585-vibethinker-3b/fig-1.png) | Overall training pipeline. | Method |
| ![fig-2](../assets/papers-explained-585-vibethinker-3b/fig-2.png) | Core benchmark performance (math). | Evaluation |
| ![fig-3](../assets/papers-explained-585-vibethinker-3b/fig-3.png) | Core benchmark performance (coding/IF). | Evaluation |
| ![fig-4](../assets/papers-explained-585-vibethinker-3b/fig-4.png) | LeetCode OOD generalization (Apr–May 2026). | Evaluation |
| ![fig-5](../assets/papers-explained-585-vibethinker-3b/fig-5.png) | Comparison vs larger reasoning models. | Evaluation |
| ![fig-6](../assets/papers-explained-585-vibethinker-3b/fig-6.png) | Curriculum SFT stage ablation. | Analysis |
| ![fig-7](../assets/papers-explained-585-vibethinker-3b/fig-7.png) | Pipeline component ablation. | Analysis |
