...
**Source**: `raw/2026-08-06_Papers-Explained-589--Weak-to-Strong-On-Policy-Distillation-6dd143fcdd0b.md`  
...
![Papers Explained 589: Weak to Strong On Policy Distillation banner](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-1.webp)
...
![Distillation Framework and Objective](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-2.webp)
...
![Empirical Results and Scaling Dynamics](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-4.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-1.webp) | Papers Explained 589 banner. | Overview |
| ![fig-2](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-2.webp) | Weak-to-strong on-policy distillation framework. | Methodology |
| ![fig-3](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-3.webp) | Reverse KL vs. Forward KL objective dynamics on student trajectories. | Methodology |
| ![fig-4](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-4.webp) | Downstream performance comparisons across student model sizes. | Experiments |
| ![fig-5](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-5.webp) | Training dynamics and loss curves across distillation regimes. | Experiments |
| ![fig-6](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-6.webp) | Impact of rollout temperature on distillation quality. | Ablations |
| ![fig-7](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-7.webp) | Error recovery and correction rate on reasoning benchmarks. | Ablations |
| ![fig-8](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-8.webp) | Token-level divergence distribution between student and teacher. | Analysis |
| ![fig-9](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-9.webp) | Benchmark accuracy across Math, Code, and General Reasoning tasks. | Results |
| ![fig-10](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-10.webp) | Comparison against offline SFT and RL baselines. | Results |
| ![fig-11](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-11.webp) | Scaling behavior with increasing teacher model scale. | Scaling |
| ![fig-12](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-12.webp) | Compute vs. performance trade-off in weak-to-strong distillation. | Efficiency |
| ![fig-13](../assets/papers-explained-589-weak-to-strong-on-policy-distillation/fig-13.webp) | Qualitative case studies of corrective error guidance. | Qualitative |
