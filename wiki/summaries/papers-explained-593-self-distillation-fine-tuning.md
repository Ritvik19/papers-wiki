...
**Source**: `raw/2026-08-12_Papers-Explained-593--Self-Distillation-Fine-Tuning-651ba44d1163.md`  
...
![Papers Explained 593: Self-Distillation Fine-Tuning banner](../assets/papers-explained-593-self-distillation-fine-tuning/fig-1.webp)
...
![SDFT Training Pipeline and Continual Learning Schema](../assets/papers-explained-593-self-distillation-fine-tuning/fig-2.webp)
...
![Evaluation Results on Continual Skill Learning](../assets/papers-explained-593-self-distillation-fine-tuning/fig-4.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-593-self-distillation-fine-tuning/fig-1.webp) | Papers Explained 593 banner. | Overview |
| ![fig-2](../assets/papers-explained-593-self-distillation-fine-tuning/fig-2.webp) | SDFT in-context teacher construction and on-policy loss. | Method |
| ![fig-3](../assets/papers-explained-593-self-distillation-fine-tuning/fig-3.webp) | Continual learning setup across sequential tasks. | Setup |
| ![fig-4](../assets/papers-explained-593-self-distillation-fine-tuning/fig-4.webp) | In-distribution vs. previous capabilities retention (SDFT vs. SFT). | Results |
| ![fig-5](../assets/papers-explained-593-self-distillation-fine-tuning/fig-5.webp) | Sequential multi-task learning accuracy curves over training rounds. | Results |
| ![fig-6](../assets/papers-explained-593-self-distillation-fine-tuning/fig-6.webp) | Knowledge acquisition evaluation on direct and indirect OOD questions. | Results |
| ![fig-7](../assets/papers-explained-593-self-distillation-fine-tuning/fig-7.webp) | Tool-use performance retention and API execution fidelity. | Results |
| ![fig-8](../assets/papers-explained-593-self-distillation-fine-tuning/fig-8.webp) | Reverse KL vs. Forward KL loss comparison during continual fine-tuning. | Ablations |
| ![fig-9](../assets/papers-explained-593-self-distillation-fine-tuning/fig-9.webp) | Number of in-context demonstration examples scaling analysis. | Ablations |
