...
**Source**: `raw/2026-08-10_Papers-Explained-591--Generalized-Knowledge-Distillation-52bebe2e0252.html`  
...
![Papers Explained 591: Generalized Knowledge Distillation banner](../assets/papers-explained-591-generalized-knowledge-distillation/fig-1.png)
...
![GKD Framework Overview and Divergences](../assets/papers-explained-591-generalized-knowledge-distillation/fig-2.png)
...
![Results and Comparison with Supervised Distillation](../assets/papers-explained-591-generalized-knowledge-distillation/fig-5.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-591-generalized-knowledge-distillation/fig-1.png) | Papers Explained 591: GKD overview banner. | Overview |
| ![fig-2](../assets/papers-explained-591-generalized-knowledge-distillation/fig-2.png) | Unified GKD framework diagram. | Method |
| ![fig-3](../assets/papers-explained-591-generalized-knowledge-distillation/fig-3.png) | Divergence formulations: Forward KL, Reverse KL, and JSD. | Method |
| ![fig-4](../assets/papers-explained-591-generalized-knowledge-distillation/fig-4.png) | Comparison of training trajectories between off-policy and on-policy KD. | Method |
| ![fig-5](../assets/papers-explained-591-generalized-knowledge-distillation/fig-5.png) | Downstream performance on text summarization and translation tasks. | Experiments |
| ![fig-6](../assets/papers-explained-591-generalized-knowledge-distillation/fig-6.png) | Exposure bias analysis and error compounding curves. | Analysis |
| ![fig-7](../assets/papers-explained-591-generalized-knowledge-distillation/fig-7.png) | Impact of the on-policy mixing parameter lambda. | Ablations |
| ![fig-8](../assets/papers-explained-591-generalized-knowledge-distillation/fig-8.png) | Forward KL vs Reverse KL vs JSD comparative evaluation. | Ablations |
| ![fig-9](../assets/papers-explained-591-generalized-knowledge-distillation/fig-9.png) | Student model scale vs distillation efficiency. | Scaling |
| ![fig-10](../assets/papers-explained-591-generalized-knowledge-distillation/fig-10.png) | Auto-regressive recovery rate from perturbed prefixes. | Analysis |
| ![fig-11](../assets/papers-explained-591-generalized-knowledge-distillation/fig-11.png) | Token-level cross-entropy loss progression during GKD training. | Training |
| ![fig-12](../assets/papers-explained-591-generalized-knowledge-distillation/fig-12.png) | Sample efficiency of on-policy distillation vs offline SFT. | Efficiency |
| ![fig-13](../assets/papers-explained-591-generalized-knowledge-distillation/fig-13.png) | Qualitative translation comparison showing error recovery. | Qualitative |
| ![fig-14](../assets/papers-explained-591-generalized-knowledge-distillation/fig-14.png) | Impact of student sampling temperature during rollout collection. | Ablations |
| ![fig-15](../assets/papers-explained-591-generalized-knowledge-distillation/fig-15.png) | Full-vocabulary vs top-p truncated teacher logit distillation. | Ablations |
| ![fig-16](../assets/papers-explained-591-generalized-knowledge-distillation/fig-16.png) | GKD on instruction-tuned conversational benchmarks. | Results |
| ![fig-17](../assets/papers-explained-591-generalized-knowledge-distillation/fig-17.png) | Summary of mathematical guarantees and divergence bounds. | Theory |
