...
**Source**: `raw/draft_Papers-Explained-581--Rubric-Guided-Self-Distillation-bd61a188450f.md`  
...
![RGSD method overview](../assets/papers-explained-581-rubric-guided-self-distillation/fig-4.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-581-rubric-guided-self-distillation/fig-1.webp) | RGSD overview banner. | Intro |
| ![fig-2](../assets/papers-explained-581-rubric-guided-self-distillation/fig-2.webp) | Rubric score aggregation formula. | Method |
| ![fig-3](../assets/papers-explained-581-rubric-guided-self-distillation/fig-3.webp) | Rubric-RL objective. | Method |
| ![fig-4](../assets/papers-explained-581-rubric-guided-self-distillation/fig-4.webp) | RGSD method overview diagram. | Method |
| ![fig-5](../assets/papers-explained-581-rubric-guided-self-distillation/fig-5.webp) | Student–teacher token distillation setup. | Method |
| ![fig-6](../assets/papers-explained-581-rubric-guided-self-distillation/fig-6.webp) | Clipped Jensen–Shannon divergence objective. | Method |
| ![fig-7](../assets/papers-explained-581-rubric-guided-self-distillation/fig-7.webp) | Hyperparameters across methods. | Setup |
| ![fig-8](../assets/papers-explained-581-rubric-guided-self-distillation/fig-8.webp) | Main results on RubricHub and OOD benchmarks. | Results |
| ![fig-9](../assets/papers-explained-581-rubric-guided-self-distillation/fig-9.webp) | Training dynamics on RubricHub-med-300. | Results |
| ![fig-10](../assets/papers-explained-581-rubric-guided-self-distillation/fig-10.webp) | Training dynamics on RubricHub-sci-300. | Results |
