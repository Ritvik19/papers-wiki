...
**Source**: `raw/2026-07-04-harness/full-article.html`, `raw/2026-07-04-harness/full-article.md`  
**Ingested**: 2026-07-21  
**Tags**: #summary
...
|--------|---------|---------|
| ![fig-1](../assets/2026-07-04-harness/fig-1.png) | Simplified Codex agent loop: tools affect next generation | Pattern 1 |
| ![fig-2](../assets/2026-07-04-harness/fig-2.png) | Coding-agent harness loop with IDE-like tools | Case study |
| ![fig-3](../assets/2026-07-04-harness/fig-3.png) | Agentic Context Engineering (ACE) framework | Context eng. |
| ![fig-4](../assets/2026-07-04-harness/fig-4.png) | Meta Context Engineering bi-level optimization | Context eng. |
| ![fig-5](../assets/2026-07-04-harness/fig-5.png) | Meta-Harness outer-loop optimization | Context eng. |
| ![fig-6](../assets/2026-07-04-harness/fig-6.png) | Meta-Harness results on classification and TerminalBench-2 | Context eng. |
| ![fig-7](../assets/2026-07-04-harness/fig-7.png) | AI Scientist end-to-end research pipeline | Workflow |
| ![fig-8](../assets/2026-07-04-harness/fig-8.png) | Autodata challenger/solver/verifier workflow | Workflow |
| ![fig-9](../assets/2026-07-04-harness/fig-9.png) | Automated Design of Agentic Systems (ADAS) | Workflow |
| ![fig-10](../assets/2026-07-04-harness/fig-10.png) | AFlow MCTS workflow optimization | Workflow |
| ![fig-11](../assets/2026-07-04-harness/fig-11.png) | AFlow experiment results vs. manual workflows | Workflow |
| ![fig-12](../assets/2026-07-04-harness/fig-12.png) | Self-Taught Optimizer (STOP) algorithm | Self-improving |
| ![fig-13](../assets/2026-07-04-harness/fig-13.png) | Strategies discovered by STOP | Self-improving |
| ![fig-14](../assets/2026-07-04-harness/fig-14.png) | Harness updating vs. harness benefit across models | Self-improving |
| ![fig-15](../assets/2026-07-04-harness/fig-15.png) | Self-Harness propose-evaluate-accept loop | Self-improving |
| ![fig-16](../assets/2026-07-04-harness/fig-16.png) | AlphaEvolve evolutionary coding-agent search | Evolutionary |
| ![fig-17](../assets/2026-07-04-harness/fig-17.png) | AlphaEvolve ablation results | Evolutionary |
| ![fig-18](../assets/2026-07-04-harness/fig-18.png) | SIA: joint harness and weight update loop | Joint opt. |
