...
**Source**: `raw/sebastien-bubeck-a-single-question-to-track-progress-from-o3-to-gpt-5-6-and-beyond/full-article.md`, `raw/sebastien-bubeck-a-single-question-to-track-progress-from-o3-to-gpt-5-6-and-beyond/full-article.md`  
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/sebastien-bubeck-a-single-question-to-track-progress-from-o3-to-gpt-5-6-and-beyond/fig-1.webp) | Header illustration for the gradient flow and self-contracted curves mathematical challenge | Cover |
| ![fig-2](../assets/sebastien-bubeck-a-single-question-to-track-progress-from-o3-to-gpt-5-6-and-beyond/fig-2.webp) | Definition of a self-contracted curve showing distance monotonicity to future points | Section 1 |
| ![fig-3](../assets/sebastien-bubeck-a-single-question-to-track-progress-from-o3-to-gpt-5-6-and-beyond/fig-3.webp) | A $\sqrt{n}$ length self-contracted curve generated by an ill-conditioned quadratic | Section 1 |

![Header illustration](../assets/sebastien-bubeck-a-single-question-to-track-progress-from-o3-to-gpt-5-6-and-beyond/fig-1.webp)

![Definition of a self-contracted curve](../assets/sebastien-bubeck-a-single-question-to-track-progress-from-o3-to-gpt-5-6-and-beyond/fig-2.webp)

![A sqrt(n) length self-contracted curve](../assets/sebastien-bubeck-a-single-question-to-track-progress-from-o3-to-gpt-5-6-and-beyond/fig-3.webp)
