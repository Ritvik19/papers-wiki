...
**Source**: `raw/draft_Papers-Explained--TinyGSM-da8672bca027.html`  
...
![Papers Explained TinyGSM banner](../assets/papers-explained-tinygsm/fig-1.png)
...
![TinyGSM Data Generation and GSM8K Results](../assets/papers-explained-tinygsm/fig-2.png)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-tinygsm/fig-1.png) | TinyGSM overview banner. | Overview |
| ![fig-2](../assets/papers-explained-tinygsm/fig-2.png) | Synthetic data generation and Python verification pipeline. | Method |
| ![fig-3](../assets/papers-explained-tinygsm/fig-3.png) | GSM8K accuracy comparison: TinyGSM vs. 7B, 13B, and 70B models. | Evaluation |
| ![fig-4](../assets/papers-explained-tinygsm/fig-4.png) | Dataset size scaling curve (1M to 12.3M synthetic problems). | Scaling |
| ![fig-5](../assets/papers-explained-tinygsm/fig-5.png) | Accuracy across mathematical operation categories. | Analysis |
| ![fig-6](../assets/papers-explained-tinygsm/fig-6.png) | Contamination and memorization analysis vs. GSM8K test set. | Contamination |
| ![fig-7](../assets/papers-explained-tinygsm/fig-7.png) | Qualitative reasoning comparison between TinyGSM and base models. | Qualitative |
