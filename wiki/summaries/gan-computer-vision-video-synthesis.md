...
**Source**: `raw/gan-computer-vision-video-synthesis/full-article.md` (358 KB), `raw/gan-computer-vision-video-synthesis/full-article.md` (markdown view)  
...
![Pix2PixHD global generator G1 + local enhancer G2 architecture](../assets/gan-computer-vision-video-synthesis/fig-1.webp)
...
![Video-to-video generator: flow warping + occlusion hallucination](../assets/gan-computer-vision-video-synthesis/fig-6.webp)
...
![BigGAN class-conditional ImageNet samples](../assets/gan-computer-vision-video-synthesis/fig-9.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/gan-computer-vision-video-synthesis/fig-1.webp) | Pix2PixHD generator: global G1 + local enhancer G2 with feature fusion | — |
| ![fig-2](../assets/gan-computer-vision-video-synthesis/fig-2.webp) | Semantic vs instance segmentation (Silberman et al. ECCV 2014) | — |
| ![fig-3](../assets/gan-computer-vision-video-synthesis/fig-3.webp) | Instance boundary map from 4-neighbor class-ID differences | — |
| ![fig-4](../assets/gan-computer-vision-video-synthesis/fig-4.webp) | Hand-crafted instance boundary maps improve synthesis | — |
| ![fig-5](../assets/gan-computer-vision-video-synthesis/fig-5.webp) | Instance-level feature embeddings: road/car style control | — |
| ![fig-6](../assets/gan-computer-vision-video-synthesis/fig-6.webp) | Vid2vid generator: FlowNet2 warping + Mask R-CNN blending + hallucinator H | — |
| ![fig-7](../assets/gan-computer-vision-video-synthesis/fig-7.webp) | Vid2vid: foreground/background prior improves results | — |
| ![fig-8](../assets/gan-computer-vision-video-synthesis/fig-8.webp) | Vid2vid instance feature embedding: per-instance road style change | — |
| ![fig-9](../assets/gan-computer-vision-video-synthesis/fig-9.webp) | BigGAN ImageNet class-conditional generation results | — |
