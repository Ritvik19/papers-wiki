...
**Source**: `raw/draft_Papers-Explained-577--MAI-Thinking-1-e5afeca9bbfc.md`  
...
![MAI-Base-1 architecture overview](../assets/papers-explained-577-mai-thinking-1/fig-2.webp)
...
![RL climbs overview](../assets/papers-explained-577-mai-thinking-1/fig-6.webp)
...
| Figure | Caption | Page |
|--------|---------|------|
| ![fig-1](../assets/papers-explained-577-mai-thinking-1/fig-1.webp) | Title banner: MAI-Thinking-1. | Header |
| ![fig-2](../assets/papers-explained-577-mai-thinking-1/fig-2.webp) | MAI-Base-1 architecture overview. | Pre-training |
| ![fig-3](../assets/papers-explained-577-mai-thinking-1/fig-3.webp) | HTML pre-training data pipeline. | Data |
| ![fig-4](../assets/papers-explained-577-mai-thinking-1/fig-4.webp) | Knowledge cut-off dates by source. | Data |
| ![fig-5](../assets/papers-explained-577-mai-thinking-1/fig-5.webp) | Data mixture rank non-invariance. | Data mix |
| ![fig-6](../assets/papers-explained-577-mai-thinking-1/fig-6.webp) | Overview of RL climbs. | Post-training |
| ![fig-7](../assets/papers-explained-577-mai-thinking-1/fig-7.webp) | GRPO objective. | RL recipe |
| ![fig-8](../assets/papers-explained-577-mai-thinking-1/fig-8.webp) | Importance-sampling ratio. | RL recipe |
| ![fig-9](../assets/papers-explained-577-mai-thinking-1/fig-9.webp) | STEM Mix dataset distribution. | STEM data |
| ![fig-10](../assets/papers-explained-577-mai-thinking-1/fig-10.webp) | STEM (q,a) extraction pipeline. | STEM data |
| ![fig-11](../assets/papers-explained-577-mai-thinking-1/fig-11.webp) | Agentic multi-step RL loop. | Agentic climb |
| ![fig-12](../assets/papers-explained-577-mai-thinking-1/fig-12.webp) | Harmful/borderline prompt sources. | Safety |
| ![fig-13](../assets/papers-explained-577-mai-thinking-1/fig-13.webp) | Style guide behavior examples. | Safety |
| ![fig-14](../assets/papers-explained-577-mai-thinking-1/fig-14.webp) | STEM + agentic benchmark results. | Evaluation |
| ![fig-15](../assets/papers-explained-577-mai-thinking-1/fig-15.webp) | General public benchmark results. | Evaluation |
