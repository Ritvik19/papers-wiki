...
- The project is available on [Github](https://github.com/QizhiPei/mathfusion).
...
*Figure: The overview of MathFusion.*
...
```text
P seq: The school has organized a trip to a museum and
...
```text
P para: A school organizes a field trip to a museum and hires
...
This means that the "#New Question#" should be an
**comparison**
and
**selection**
of the previous answers, not their
**combination**
.
There are some examples for the "#New Question#":
1.
Who sells the most items?
2.
How much money does the top earner make?
3.
Which is the cheaper plan?
4.
Someone has 200 dollor, which item can he afford?
...
```text
P cond: A local community is organizing two different outings.
...
*Figure: Comparison between MathFusionQA and previous mathematical datasets.*
...
*Figure: Performance comparison on mathematical benchmarks.*
...
MathFusion: Enhancing Mathematic Problem-solving of LLM through Instruction Fusion [2503.16212](https://arxiv.org/abs/2503.16212)
