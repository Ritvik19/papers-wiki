...
This paper can be seen as a tutorial for building a VLM. It begins by providing a comprehensive overview of the current state-of-the-art approaches, highlighting the strengths and weaknesses of each, addressing the major challenges in the field, and suggesting promising research directions for under explored areas.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Vision Language Models]], [[Large Language Models]], [[Model Compression and Efficiency]], [[Long Context]], [[Embedding and Retrieval]].
...
- This paper can be seen as a tutorial for building a VLM. It begins by providing a comprehensive overview of the current state-of-the-art approaches, highlighting the strengths and weaknesses of each, addressing the major challenges in the field, and...
- The model is available at [HuggingFace](https://huggingface.co/HuggingFaceM4/Idefics3-8B-Llama3).
- Recommended Reading [Papers Explained 180: Idefics 2](https://ritvik19.medium.com/papers-explained-180-idefics-2-0adf35cef4ee)
- Most VLMs have been built on top of unimodal pre-trained backbones, a language model and/or a vision encoder, rather than training entirely new models from scratch.
- The cross-attention architecture significantly outperforms when the backbones are kept frozen during training.
...
*Figure: The self-attention, or fully-autoregressive, architecture.*
...
*Figure: The different stages of training and the types of datasets used.*
...
*Figure: Overview of the pipeline used for the creation of Docmatix.*
...
*Figure: The different training stages of Idefics3, along with the parameters and datasets used.*
...
*Figure: Performance of Idefics3 against Idefics2–8B and Idefics2–70B. The evaluations are done in zero shot and without any chain-of-thought prompting.*

*Figure: Detailed performance of Idefics3 across each category of MMMU.*
...
Building and better understanding vision-language models: insights and future directions [2408.12637](https://arxiv.org/abs/2408.12637)
