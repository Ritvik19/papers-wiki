...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Reinforcement Learning Topic]], [[Synthetic Data]], [[Large Language Models]], [[Model Compression and Efficiency]], [[Supervised Fine-Tuning]].
...
- Thinking Preference Optimization (ThinkPO) utilizes readily available or easily obtainable short CoT reasoning responses as rejected answers and long CoT responses as chosen answers for the same question.
...
- The dataset Dsft = {(q,olong)}N is based on a bespoke stratos dataset. DeepSeek-R1 was used as the teacher reasoning model instead of QwQ-32B-Preview to generate long reasoning response olong and GPT-4o-mini is employed in place of Sky-thought T1’s parsing...
...
Thinking Preference Optimization [2502.13173](https://arxiv.org/abs/2502.13173)
