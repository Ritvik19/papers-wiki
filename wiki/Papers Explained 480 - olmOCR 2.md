...
olmOCR 2 is a specialized, 7B vision language model (VLM) trained using reinforcement learning with verifiable rewards (RLVR), where the rewards are a diverse set of binary unit tests.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Document AI]], [[Reinforcement Learning Topic]], [[Vision Language Models]], [[Reasoning Models]], [[Large Language Models]], [[Reinforcement Learning]], [[Verifier-Bounded Learning]].
...
*Figure: OCR model performance comparison.*
...
olmOCR 2: Unit Test Rewards for Document OCR [2510.19817](https://arxiv.org/abs/2510.19817)
