...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Synthetic Data]], [[Document AI]], [[Vision Language Models]], [[Safety and Alignment]], [[Reasoning Models]], [[Supervised Fine-Tuning]].
...
- To achieve both scale and diversity while maintaining accessibility for open-source initiatives, data is sourced from 153 publicly available multimodal instruction datasets.
...
*Figure: Overview of the visual instruction data rewriting pipeline.*
...
*Figure: The data distribution of MAmmoTH-VL-Instruct (12M).*
...
*Figure: Detailed configuration for each training stage of the MAmmoTH-VL-8B model.*

## Evaluation

### Single-Image Performance

*Figure: Performance on multi-discipline knowledge and mathematical reasoning benchmarks.*

*Figure: Main results on Chart, Diagram, and Document Understanding, and Real-world Multimodal Interactions and Human Preferences benchmarks.*
...
*Figure: Main results on Multi-Image and Video benchmarks.*
...
MAmmoTH-VL: Eliciting Multimodal Reasoning with Instruction Tuning at Scale [2412.05237](https://arxiv.org/abs/2412.05237)
