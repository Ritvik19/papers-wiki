...
- Source file: `raw/2025-03-05_Papers-Explained-323--SysGen-e0826a205925.md`
...
Figures from the Medium HTML export (`raw/2025-03-05_Papers-Explained-323--SysGen-e0826a205925.md`); local copies under `wiki/assets/papers-explained-323-sysgen/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-323-sysgen/fig-1.webp) | Title card: SysGen. |
| ![Figure 2](assets/papers-explained-323-sysgen/fig-2.webp) | Overall SysGen data construction pipeline. |
| ![Figure 3](assets/papers-explained-323-sysgen/fig-3.webp) | The prompt of generating system messages using open-source models. |
| ![Figure 4](assets/papers-explained-323-sysgen/fig-4.webp) | The prompt of verification of key functionalities using open-source models with annotated system messages and filtered system messages. |
| ![Figure 5](assets/papers-explained-323-sysgen/fig-5.webp) | The prompt of answer quality check through the proprietary model. |
| ![Figure 6](assets/papers-explained-323-sysgen/fig-6.webp) | Statistics of the newly-generated answer compared to average context length of the original answer. |
| ![Figure 7](assets/papers-explained-323-sysgen/fig-7.webp) | The proportion of cases where the new responses are judged to be better aligned than the original responses when given the user instructions. |
| ![Figure 8](assets/papers-explained-323-sysgen/fig-8.webp) | Remaining instances and percentage after adopting SysGen data per open-source models. |
| ![Figure 9](assets/papers-explained-323-sysgen/fig-9.webp) | Multifacet benchmark evaluates how well a model aligns with both the system message and user instruction when generating responses. |
| ![Figure 10](assets/papers-explained-323-sysgen/fig-10.webp) | KD experiments leveraging data generated by SysGen pipeline using Phi-4. |
| ![Figure 11](assets/papers-explained-323-sysgen/fig-11.webp) | Open LLM Leaderboard 2. |
| ![Figure 12](assets/papers-explained-323-sysgen/fig-12.webp) | Ablation studies of using system message and assistant’s response. |
## Related
