...
The data and models are available at [HuggingFace](https://huggingface.co/collections/allenai/olmocr).

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Document AI]], [[Large Language Models]], [[Vision Language Models]], [[Reinforcement Learning Topic]], [[Verifier-Bounded Learning]].
...
- The pypdf library was used to extract a representation of the page’s structure from the PDF’s internal data.
...
- olmOCR-Bench operates by assessing a series of predefined pass-or-fail “unit-tests”.
...
*Figure: olmOCR-mix-0225 composition.*
...
*Figure: Counts of unit test types in olmOCR-Bench.*
...
*Figure: Evaluation results on olmOCR-Bench grouped by document types.*
...
*Figure: Inference cost comparison against other OCR methods.*
...
- [[Papers Explained: OLMo 3]] — olmOCR is the core PDF extraction engine used to build Dolma 3's science PDF pool (238M crawled PDFs → 148M documents after filtering) and the long-context extension data pool.
