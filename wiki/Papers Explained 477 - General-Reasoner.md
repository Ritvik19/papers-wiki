...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Synthetic Data]], [[Large Language Models]], [[Reinforcement Learning Topic]], [[Code Models]], [[Verifier-Bounded Learning]], [[Supervised Fine-Tuning]], [[Reinforcement Learning]].
...
- Current works for LLM reasoning mainly focus on mathematical and coding domains, largely due to data abundance and the ease of answer verification.
- General-Reasoner is a novel training paradigm designed to enhance LLM reasoning capabilities across diverse domains.
- The project is available on [GitHub](https://tiger-ai-lab.github.io/General-Reasoner/).
- WebInstruct dataset is used as the initial dataset, which comprises approximately 5 million naturally occurring, web-crawled instructions from high-quality resource websites like StackExchange and various educational portals.
...
*Figure: Hyperparameter settings for General-Reasoner variants.*

## Evaluation

*Figure: Accuracy comparison on general reasoning benchmarks.*

*Figure: Math task accuracy across datasets.*
...
General-Reasoner: Advancing LLM Reasoning Across All Domains [2505.14652](https://arxiv.org/abs/2505.14652)
