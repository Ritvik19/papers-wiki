...
- Source file: `raw/2024-12-24_Papers-Explained-278--Phi-4-ea59220f3f88.md`
...
Figures from the Medium HTML export (`raw/2024-12-24_Papers-Explained-278--Phi-4-ea59220f3f88.md`); local copies under `wiki/assets/papers-explained-278-phi-4/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-278-phi-4/fig-1.webp) | Title card: Phi-4. |
| ![Figure 2](assets/papers-explained-278-phi-4/fig-2.webp) | Data mixture for pretraining. |
| ![Figure 3](assets/papers-explained-278-phi-4/fig-3.webp) | Data Mixture for Pivotal Token DPO and Judge Guided DPO. |
| ![Figure 4](assets/papers-explained-278-phi-4/fig-4.webp) | Illustration of pivotal tokens for GPT-4o at temperature 1. |
| ![Figure 5](assets/papers-explained-278-phi-4/fig-5.webp) | Pseudocode for Pivotal Token Search (PTS). |
| ![Figure 6](assets/papers-explained-278-phi-4/fig-6.webp) | Sample Preference data generated by Pivotal Token Search. |
| ![Figure 7](assets/papers-explained-278-phi-4/fig-7.webp) | Performance of phi-4 on a set of standard benchmarks. |
## Related
