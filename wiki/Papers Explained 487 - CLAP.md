...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Audio Models]], [[Vision Language Models]], [[Embedding and Retrieval]].
...
- The input consists of audio and text pairs passed to an audio encoder and a text encoder. Both representations are connected in a joint multimodal space with linear projections.
...
*Figure: Training dataset statistics.*
...
*Figure: Datasets used as Downstream Tasks.*
...
CLAP: Learning Audio Concepts From Natural Language Supervision [2206.04769](https://arxiv.org/abs/2206.04769)
