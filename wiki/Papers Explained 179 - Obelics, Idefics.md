...
- The models and dataset are available at [HuggingFace](https://huggingface.co/collections/HuggingFaceM4/idefics-6509a1aaabdde5290e80b855).
...
*Figure: Overview of the steps involved in creating Obelics.*
...
*Figure: Breakdown of model parameters.*
...
*Figure: Training Hyper-Parameters.*

The four runs conducted have distinct data mixtures as follows

*Figure: Number of tokens and images in the different datasets used for the training.*

*Figure: Breakdown of the dataset mixtures used.*

### Evaluation

*Figure: Performance of Idefics against OpenFlamingo and Flamingo.*
...
OBELICS: An Open Web-Scale Filtered Dataset of Interleaved Image-Text Documents [2306.16527](https://arxiv.org/abs/2306.16527)

Recommended Reading [Datasets](https://ritvik19.medium.com/list/datasets-b465a5d8a2d6) [Multi Modal Transformers](https://ritvik19.medium.com/list/multi-modal-transformers-67453f215ecf)
