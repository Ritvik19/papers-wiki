...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reinforcement Learning Topic]], [[Agentic AI]], [[Reasoning Models]], [[Reinforcement Learning]].
...
- The project is available on [GitHub](https://unary-feedback.github.io/).
...
*Figure: Single-turn RL causes LLMs to repeat the same answer across turns instead of revising based on feedback.*
...
*Figure: Hugging Face model names used in the unique answer ratio evaluation.*

*Figure: Comparison of effective (unique) answer ratio (%) before and after RL training.*
...
*Figure: The UFO framework for multi-turn training.*
...
*Figure: Performance comparison when evaluating with 5 turns after training with different maximum turns (1, 5, and 10).*
...
*Figure: Validation performance (Succ@k) of models trained with different roll-out turns under varying inferencetime turn budgets.*
...
*Figure: 5-turn success rate (%) across different tasks and training settings.*
...
*Figure: Comparison of success rate with multi-turn setting.*
...
*Figure: Validation under different verbal feedback prompts.*
...
*Figure: Comparison of reward shaping strategies.*
...
*Figure: Proportion of effective answers over training.*

- Reducing duplicate answers is important because high repetition rates lead to higher penalties and lower overall rewards.

## Paper

A Simple “Try Again” Can Elicit Multi-Turn LLM Reasoning [2507.14295](https://arxiv.org/abs/2507.14295)
