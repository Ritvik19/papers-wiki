...
- [InceptionNetV2 and InceptionNetV3 (2015)](#d7b3)
- [InceptionNetV4 and InceptionResNet (2016)](#83ad)
- LeNet is a convolutional neural network architecture that was developed by Yann LeCun in the late 1980s and early 1990s.
- LeNet is a relatively simple architecture that consists of multiple layers of convolutional, pooling, and fully connected layers.
- LeNet was one of the first architectures to demonstrate the effectiveness of convolutional neural networks for image classification tasks.
...
- [MobileNetV1 (2017)](#3cb5)

- [MobileNetV2 (2018)](#4440)

- [MobileNetV3 (2019)](#8eb6)

- [EfficientNet (2019)](#560a)
