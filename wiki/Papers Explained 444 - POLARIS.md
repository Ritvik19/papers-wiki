...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reinforcement Learning Topic]], [[Large Language Models]], [[Synthetic Data]], [[Reasoning Models]], [[Model Compression and Efficiency]], [[Reinforcement Learning]].
...
- Previous RL training methods, while effective for smaller models (e.g., 1.5B parameters), showed only marginal improvements or even performance decline when applied to more advanced models like Qwen3.
...
*Figure: Model performance across the three above mentioned conditions.*
...
*Figure: Data Difficulty Distribution Shifts (Left: Before Training, Right: After-Training; Top: Qwen3–4B, Bottom: Deepseek-R1-distill-Qwen-7B)*
...
*Figure: Rollout diversity with sampling temperature on R1-Distill-Qwen and Qwen3 across different model sizes.*
...
*Figure: Model performance with sampling temperature on R1-Distill-Qwen and Qwen3 across different model sizes.*
...
*Figure: The RGZ and CEZ shift towards the high-temperature region following 800 steps of RL training.*
...
*Figure: An illustration of Rollout Rescue Mechanism.*
