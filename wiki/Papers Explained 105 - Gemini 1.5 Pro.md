...
Gemini 1.5 Pro marks a significant milestone in the evolution of multi-modal mixture-of-experts models, pushing the boundaries of compute efficiency, reasoning, and long-context performance.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Large Language Models]], [[Long Context]], [[Mixture of Experts]], [[Vision Language Models]], [[Audio Models]].
...
- Gemini 1.5 Pro is built upon a sparse mixture-of-experts Transformer based architecture, inheriting and enhancing the multimodal capabilities of its predecessor, Gemini 1.0.
- This facilitates the model’s long-context understanding, enabling it to process inputs up to 10 million tokens in length.
...
*Figure: Gemini 1.5 Pro compared to Gemini 1.0 family.*
...
*Figure: Cumulative average negative log-likelihood (NLL) as a function of token position in long documents and code data. A lower value demonstrates better prediction.*
...
*Figure: Comparison of Gemini 1.5 Pro with GPT-4 Turbo for the text needle-in-a-haystack task.*
...
*Figure: Audio version of the needle-in-a-haystack experiment comparing Gemini 1.5 Pro and a combination of Whisper and GPT-4 Turbo.*
...
*Figure: Evaluating the ability to answer questions about large collections of text across three context sizes.*
...
*Figure: Comparison between GPT-4V and Gemini 1.5 Pro on 1H-VideoQA.*
...
*Figure: Gemini 1.5 Pro vs Gemini 1.0*
...
*Figure: Evaluation results of Gemini 1.5 Pro and Gemini 1.0 models on standard coding, multilingual as well as maths, science and reasoning benchmarks.*
...
*Figure: Comparison of Gemini 1.5 Pro with Gemini 1.0 Pro and Ultra on image and video understanding benchmarks.*
...
[Gemini 1.5: Unlocking multi-modal understanding across millions of tokens of context](https://storage.googleapis.com/deepmind-media/gemini/gemini_v1_5_report.pdf)
