...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Large Language Models]], [[Reasoning Models]], [[Synthetic Data]], [[Evaluation and Benchmarks]], [[Supervised Fine-Tuning]].
...
- This research investigates the underlying factors that potentially enhance the mathematical reasoning capabilities of large language models (LLMs).
...
*Figure: Overview of the proposed two-stage method.*
...
*Figure: Summary of math reasoning performance of closed- and open-source LLM models in terms of accuracy (%).*
...
*Figure: The zero-shot top1 performance of Skywork-Math 7B model series.*
...
Skywork-Math: Data Scaling Laws for Mathematical Reasoning in Large Language Models — The Story Goes On [2407.08348](https://arxiv.org/abs/2407.08348)
