...
- Source file: `raw/2024-11-29_Papers-Explained-262--PromptWizard-228568783085.html`
...
Figures from the Medium HTML export (`raw/2024-11-29_Papers-Explained-262--PromptWizard-228568783085.html`); local copies under `wiki/assets/papers-explained-262-promptwizard/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-262-promptwizard/fig-1.png) | Title card: PromptWizard. |
| ![Figure 2](assets/papers-explained-262-promptwizard/fig-2.png) | Overview of PromptWizard framework. |
| ![Figure 3](assets/papers-explained-262-promptwizard/fig-3.png) | The approach follows a principled strategy through several key steps. |
| ![Figure 4](assets/papers-explained-262-promptwizard/fig-4.png) | The approach follows a principled strategy through several key steps. |
| ![Figure 5](assets/papers-explained-262-promptwizard/fig-5.png) | Candidate examples are extracted from the dataset to optimize prompt instructions and few-shot examples. |
| ![Figure 6](assets/papers-explained-262-promptwizard/fig-6.png) | This step has two main goals. |
| ![Figure 7](assets/papers-explained-262-promptwizard/fig-7.png) | Average test accuracy achieved by best instruction generated by different SOTA algorithms. |
| ![Figure 8](assets/papers-explained-262-promptwizard/fig-8.png) | Perf. on arithmetic tasks. |
| ![Figure 9](assets/papers-explained-262-promptwizard/fig-9.png) | Perf. on BBH. |
## Related
