...
- Source file: `raw/2025-01-02_Papers-Explained-279--LearnLM-Tutor-77503db05415.html`
...
Figures from the Medium HTML export (`raw/2025-01-02_Papers-Explained-279--LearnLM-Tutor-77503db05415.html`); local copies under `wiki/assets/papers-explained-279-learnlm-tutor/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-279-learnlm-tutor/fig-1.png) | Title card: LearnLM Tutor. |
| ![Figure 2](assets/papers-explained-279-learnlm-tutor/fig-2.png) | LearnLM-Tutor Development. |
| ![Figure 3](assets/papers-explained-279-learnlm-tutor/fig-3.png) | Overview of the evaluation taxonomy. |
| ![Figure 4](assets/papers-explained-279-learnlm-tutor/fig-4.png) | Data collection: Participants To evaluate a gen AI tutor,its responses in learning conversations needs to be collected. |
| ![Figure 5](assets/papers-explained-279-learnlm-tutor/fig-5.png) | Data collection: Single- or multi-turn Should single conversation turns be collected individually, or should many turns be collected... |
| ![Figure 6](assets/papers-explained-279-learnlm-tutor/fig-6.png) | Data collection: Learner proficiency Assuming paid participants are used to simulate learning interactions, should they be experts or... |
| ![Figure 7](assets/papers-explained-279-learnlm-tutor/fig-7.png) | Ratings: Evaluation Type Should tutor responses be rated by humans or automated strategies? |
| ![Figure 8](assets/papers-explained-279-learnlm-tutor/fig-8.png) | Ratings: Evaluation Type Should tutor responses be rated by humans or automated strategies? |
| ![Figure 9](assets/papers-explained-279-learnlm-tutor/fig-9.png) | Ratings: Rater Perspective Learners and educators have different perspectives on what makes a good tutor response. |
| ![Figure 10](assets/papers-explained-279-learnlm-tutor/fig-10.png) | Ratings: Comparative evaluations When comparing gen AI tutors, should we evaluate each on its own using common benchmarks, or should we... |
| ![Figure 11](assets/papers-explained-279-learnlm-tutor/fig-11.png) | Proposed Approach. |
| ![Figure 12](assets/papers-explained-279-learnlm-tutor/fig-12.png) | Unguided conversations: Subjective learner feedback. |
| ![Figure 13](assets/papers-explained-279-learnlm-tutor/fig-13.png) | Expert pedagogical raters reviewed and rated unguided conversations between learners and both LearnLM-Tutor and Gemini 1.0. |
| ![Figure 14](assets/papers-explained-279-learnlm-tutor/fig-14.png) | Conversation-level pedagogy: teacher feedback. |
| ![Figure 15](assets/papers-explained-279-learnlm-tutor/fig-15.png) | Raters ranked pairs of conversations generated by LearnLM-Tutor and Gemini 1.0 based on five criteria adapted from the GenAI for Education... |
## Related
