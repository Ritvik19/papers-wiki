...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Model Compression and Efficiency]], [[Document AI]], [[Computer Vision]], [[Embedding and Retrieval]].
...
- where the j-th head computes the self-attention over Xij , which is the j-th split of the input feature Xi , i.e., Xi = [Xi1, Xi2, . . . , Xih] and 1 ≤ j ≤ h.
- To improve parameter efficiency, the parameters in the network are reallocated by expanding the channel width of critical modules while shrinking the unimportant ones. Small channel dimensions are set for Q and K projections in each head for all stages.
...
*Figure: Overview of EfficientViT. (a) Architecture of EfficientViT; (b) Sandwich Layout block; © Cascaded Group Attention.*
...
*Figure: Architecture details of EfficientViT model variants*

## Evaluation

### Image Classification

*Figure: EfficientViT image classification performance on ImageNet-1K with comparisons to state-of-the-art efficient CNN and ViT models trained without extra data.*
...
*Figure: EfficientViT object detection performance on COCO val2017.*
...
EfficientViT: Memory Efficient Vision Transformer with Cascaded Group Attention [2305.07027](https://arxiv.org/abs/2305.07027)
