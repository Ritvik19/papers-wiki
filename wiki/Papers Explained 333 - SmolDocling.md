...
SmolDocling is a 256M parameter vision-language model Based on Hugging Face’s SmolVLM designed for end-to-end document conversion. It processes entire pages by generating DocTags, a novel markup format optimized for the LLM backbone that captures all page elements, including their location and context.

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Document AI]], [[Large Language Models]], [[Vision Language Models]], [[Code Models]], [[Evaluation and Benchmarks]].
...
- SmolDocling is a 256M parameter vision-language model Based on Hugging Face’s SmolVLM designed for end-to-end document conversion.
- SmolDocling exhibits robust performance in correctly reproducing document features such as code listings, tables, equations, charts, lists, and more across a diverse range of document types including business documents, academic papers, technical reports...
- The model is available on [HuggingFace](https://huggingface.co/ds4sd/SmolDocling-256M-preview/).
...
*Figure: SmolDocling/SmolVLM architecture.*
...
*Figure: Structured document text recognition.*
...
*Figure: Layout analysis comparison.*
...
*Figure: Table structure and cell content reconstruction.*
...
SmolDocling: An ultra-compact vision-language model for end-to-end multi-modal document conversion [2503.11576](https://arxiv.org/abs/2503.11576)
