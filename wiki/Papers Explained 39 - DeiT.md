...
- Source file: `raw/2023-03-27_Papers-Explained-39--DeiT-3d78dd98c8ec.md`
...
Figures from the Medium HTML export (`raw/2023-03-27_Papers-Explained-39--DeiT-3d78dd98c8ec.md`); local copies under `wiki/assets/papers-explained-39-deit/` when download succeeded.

| Figure | Caption |
|--------|---------|
| ![Figure 1](assets/papers-explained-39-deit/fig-1.webp) | Title card: DeiT. |
| ![Figure 2](assets/papers-explained-39-deit/fig-2.webp) | DeiT is a competitive convolution-free transformer trained on Imagenet only. |
| ![Figure 3](assets/papers-explained-39-deit/fig-3.webp) | The architecture design of DeiT is identical to the one proposed by ViT with no convolutions. |
| ![Figure 4](assets/papers-explained-39-deit/fig-4.webp) | minimizes the Kullback-Leibler divergence between the softmax of the teacher and the softmax of the student model. |
| ![Figure 5](assets/papers-explained-39-deit/fig-5.webp) | we take the hard decision of the teacher as a true label. |
| ![Figure 6](assets/papers-explained-39-deit/fig-6.webp) | We have observed that using a convnet teacher gives better performance than using a transformer. |
| ![Figure 7](assets/papers-explained-39-deit/fig-7.webp) | The distillation token gives slightly better results than the class token. |
| ![Figure 8](assets/papers-explained-39-deit/fig-8.webp) | Our distilled model is more correlated to the convnet than with a transformer learned from scratch. |
| ![Figure 9](assets/papers-explained-39-deit/fig-9.webp) | Our distilled model is more correlated to the convnet than with a transformer learned from scratch. |
## Related
