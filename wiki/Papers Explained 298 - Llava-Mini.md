...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Vision Language Models]], [[Model Compression and Efficiency]], [[Large Language Models]], [[Embedding and Retrieval]], [[Computer Vision]].
...
- Typically, a pre-trained CLIP ViT-L/14 and a projection layer are employed to encode the visual inputs Xv into vision tokens (i.e., continuous representations) Hv.
- The importance of visual tokens at each layer of LLMs is evaluated from an attention-based perspective.
- To further assess the importance of individual visual tokens, the entropy of the attention distribution at each layer is calculated.
- The visual understanding ability of LMMs is evaluated when visual tokens are dropped at different layers. LLaVA-v1.5 is tested on GQA and MMBench with visual tokens being removed at layers 1–4, then 5–8, and so on up to layers 29–32.
...
*Figure: Layer-wise variation of attention weights assigned to different types of tokens (including instruction, vision, and response) in LMMs.*
...
*Figure: Attention entropy assigned to different types of tokens across different layers in LMMs.*
...
*Figure: Performance of LLaVA-v1.5 when removing all vision tokens in various layers of LMM.*
...
*Figure: Architecture of LLaVA-Mini.*
...
*Figure: Performance on 11 image-based benchmarks.*
...
*Figure: Performance on video-based open-ended generative benchmarks.*

*Figure: Performance on MVBench (accuracy).*
...
*Figure: Results on MLVU (accuracy) of long video understanding.*

*Figure: Results on EgoSchema (accuracy), a long-form video benchmark (∼ 3 minutes) for first-person view temporal reasoning.*
...
*Figure: Performance of LLaVA-Mini with different numbers of modality pre-fusion layers Nfusion.*
...
*Figure: Performance of LLaVA-Mini with various vision tokens.*
...
LLaVA-Mini: Efficient Image and Video Large Multimodal Models with One Vision Token [2501.03895](https://arxiv.org/abs/2501.03895)
