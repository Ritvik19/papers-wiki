...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Large Language Models]], [[Synthetic Data]], [[Model Compression and Efficiency]], [[Evaluation and Benchmarks]], [[Supervised Fine-Tuning]].
...
- While encoder pretraining has traditionally relied on Masked Language Modeling (MLM), recent evidence suggests that decoder models pretrained with Causal Language Modeling (CLM) can be effectively repurposed as encoders, often surpassing traditional encoders...
- This paper addresses whether these gains reflect an inherent advantage of the CLM objective or arise from confounding factors such as model and data scale, through a series of large-scale, carefully controlled pretraining ablations.
...
*Figure: Experimental setup overview and key results on sequence classification.*
...
*Figure: MLM vs. CLM downstream performance, averaged across tasks and reported for all model sizes.*
...
*Figure: Task-wise downstream performance across different masking ratios for all model sizes.*
...
*Figure: Downstream performance as a function of pretraining steps for CLM and MLM objectives.*
...
*Figure: Impact of the fine-tuning learning rate on MLM- vs. CLM-pretrained models.*
...
*Figure: Impact of two-stage CLM+MLM pretraining on downstream performance under different training
budgets.*
...
*Figure: Comparison of downstream performance variability across different masking ratios for CLM and CLM+MLM pretraining configurations.*
...
*Figure: Impact of performing MLM CPT on either CLM- or MLM-pretrained models.*
...
*Figure: MLM loss curves for CLM- and MLM-pretrained models across the 3 CPT compute budgets.*
...
*Figure: Downstream performance as a function of CPT length for CLM- and MLM-pretrained models.*
...
Should We Still Pretrain Encoders with Masked Language Modeling? [2507.00994](https://arxiv.org/abs/2507.00994)
