...
- PEGASUS (Pre-training with Extracted Gap-sentences for Abstractive SUmmarization Sequence-to-sequence models) utilizes the same encoder-decoder model architecture as BART.
...
PEGASUS: Pre-training with Extracted Gap-sentences for Abstractive Summarization [1912.08777](https://arxiv.org/abs/1912.08777)
