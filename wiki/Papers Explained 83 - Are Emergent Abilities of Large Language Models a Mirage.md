...
This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Large Language Models]], [[Agentic AI]].
...
- Large language models are claimed to demonstrate certain emergent abilities which are not present at smaller scales. These emergent abilities are intriguing because of their sharpness i.e.
...
- [C] If the researcher scores models’ outputs using a nonlinear metric such as Accuracy (which requires a sequence of tokens to all be correct), the metric choice non-linearly scales performance, causing performance to change sharply and unpredictably in a...
...
*Figure: Emergent abilities of large language models are created by the researcher’s chosen metrics, not unpredictable changes in model behavior with scale.*
...
*Figure: Claimed emergent abilities evaporate upon changing the metric.*
...
*Figure: Claimed emergent abilities evaporate upon using better statistics.*
...
*Figure: Emergent abilities appear only for specific metrics, not task-model families.*
...
*Figure: Changing the metric when evaluating task-model family pairs causes emergent abilities to disappear.*
...
*Figure: Induced emergent reconstruction ability in shallow nonlinear autoencoders.*
...
*Figure: Induced emergent classification ability in autoregressive Transformers.*
...
Are Emergent Abilities of Large Language Models a Mirage? [2304.15004](https://arxiv.org/abs/2304.15004)
