...
Phi-4-reasoning-vision-15B is a compact open-weight multimodal reasoning model that balances reasoning power, efficiency, and training data needs. The model was trained with 200 billion tokens of multimodal data leveraging Phi-4-Reasoning (trained with 16 billion tokens) based on a core model Phi-4 (400 billion unique tokens).

This page ingests the source article into the wiki and connects it to [[Papers Explained Corpus]], [[Reasoning Models]], [[Large Language Models]], [[Vision Language Models]], [[Model Compression and Efficiency]], [[Synthetic Data]].
...
- Phi-4-reasoning-vision-15B is a compact open-weight multimodal reasoning model that balances reasoning power, efficiency, and training data needs.
- The model is available on [HuggingFace](https://huggingface.co/microsoft/Phi-4-reasoning-vision-15B).
- Early-fusion models, by contrast, process all image patches and text tokens into a single transformer, allowing unrestricted cross-attention across modalities throughout the network.
...
*Figure: Overview of the Phi-4-reasoning-vision-15B mid-fusion architecture.*
...
*Figure: Results with different resolution handling approaches.*
...
*Figure: Training recipe for Phi-4-reasoning-vision-15B.*
...
*Figure: Training hyperparameters by stage.*
...
*Figure: Open-Source Training Data Sources for Stages 1–3.*
...
*Figure: Varying the ratios of math and CUA data.*
...
*Figure: Accuracy comparisons relative to popular open-weight, non-thinking models.*

*Figure: Accuracy comparisons relative to popular open-weight, thinking models.*
...
Phi-4-reasoning-vision-15B Technical Report [2603.03975](https://arxiv.org/abs/2603.03975)
