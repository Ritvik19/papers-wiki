...
Results
Comparison with existing published models on the DUE-Benchmark. Modality T, L, V denote text, layout, or visionPerformance on FUNSD, CORD, and RVL-CDIP datasets. Modality V, T, L denote vision, text, and layout
Paper
...
By Ritvik Rastogi on April 18, 2023.
