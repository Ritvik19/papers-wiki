...
**Source URL**: https://mistral.ai/news/mistral-large/
...
-  **Self-deployment**: our models can be deployed on your environment for the most sensitive use cases with access to our model weights; Read success stories on this kind of deployment, and [ contact our team ](https://mistral.ai/contact/) for further details. 
