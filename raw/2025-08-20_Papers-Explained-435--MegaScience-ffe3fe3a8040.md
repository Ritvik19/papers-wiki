...
The open-source community has primarily focused on mathematics and coding while neglecting the scientific domain, largely due to the…
...
All the artifacts are available on HuggingFace.
...
Hyperparameters of supervised finetuning.The main results for scientific reasoning.Comparison between models trained on MegaScience and official instruction-tuned
models.
...
MegaScience: Pushing the Frontiers of Post-Training Datasets for Science Reasoning 2507.16812
...
By Ritvik Rastogi on August 20, 2025.
