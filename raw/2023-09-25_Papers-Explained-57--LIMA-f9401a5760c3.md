...
Large language models are trained in two stages: (1) unsupervised pretraining from raw text, to learn general-purpose representations, and…
...
Results
Human preference evaluation, comparing LIMA to 5 different baselines across 300 test promptsPreference evaluation using GPT-4 as the annotator, given the same instructions provided to humans.
...
By Ritvik Rastogi on September 25, 2023.
