...
While existing large vision models excel in transfer learning, they struggle to perform a diversity of tasks with simple instructions…
...
Recommended Reading [Papers Explained 213: Florence]
...
Model configuration of different size.
...
Collection of dataset for finetuning one single generalist model for downstream tasks evaluation.
...
Performance of specialist and generalist models on captioning and VQA tasks.Performance of specialist and generalist models on region-level tasks.
...
COCO object detection and instance segmentation results using Mask-RCNN framework, and COCO object detection results using DINO-4scale framework.Downstream task fine-tuning on COCO and ADE20K dataset. COCO object detection using Mask R-CNN and DINO. ADE20K semantic segmentation using UperNet.ADE20K semantic segmentation results using UperNet.
...
Florence-2: Advancing a Unified Representation for a Variety of Vision Tasks 2311.06242
...
By Ritvik Rastogi on September 19, 2024.
