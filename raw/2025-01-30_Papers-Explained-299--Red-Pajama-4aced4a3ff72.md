...
RedPajama-V1 is an open reproduction of the LLaMA training dataset. In addition, RedPajama-V2 is a massive web-only dataset consisting of…
...
Results for RedPajama-INCITE-Base-3B-v1 on a subset of lm-evaluation-harness (ZeroShot) and HELM.HELM Benchmark results for RedPajama-INCITE-Base-7B-v1 and instruction tuned.
...
Evaluations for the 468M parameter LM for different dataset filters and other SOTA web datasets.Aggregated evaluations for the 1.6B parameter LM for different datasets.
...
RedPajama: an Open Dataset for Training Large Language Models 2411.12372
...
By Ritvik Rastogi on January 30, 2025.
