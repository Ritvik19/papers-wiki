...
_Our six rerankers paired with google/embeddinggemma-300m on MTEB(eng, v2) Retrieval. See Results for five more embedder pairings._
...
| [MTEB(eng, v2) Retrieval with static-retrieval-mrl-en-v1 + reranker](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/ettin-reranker/mteb%5Fndcg10%5Fstatic-retrieval-mrl-en-v1.png) | [MTEB(eng, v2) Retrieval with all-MiniLM-L6-v2 + reranker](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/ettin-reranker/mteb%5Fndcg10%5Fall-MiniLM-L6-v2.png)                                               |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [MTEB(eng, v2) Retrieval with bge-small-en-v1.5 + reranker](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/ettin-reranker/mteb%5Fndcg10%5Fbge-small-en-v1.5.png)                   | [MTEB(eng, v2) Retrieval with nomic-embed-text-v1.5 + reranker](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/ettin-reranker/mteb%5Fndcg10%5Fnomic-embed-text-v1.5.png)                                     |
| [MTEB(eng, v2) Retrieval with embeddinggemma-300m + reranker](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/ettin-reranker/mteb%5Fndcg10%5Fembeddinggemma-300m.png)               | [MTEB(eng, v2) Retrieval with jina-embeddings-v5-text-small-retrieval + reranker](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/ettin-reranker/mteb%5Fndcg10%5Fjina-embeddings-v5-text-small-retrieval.png) |
...
cross-encoder/ettin-reranker-150m-v1  Text Ranking •  0.1B • Updated May 19 •  7.55k •  2 

cross-encoder/ettin-reranker-17m-v1  Text Ranking •  16.8M • Updated May 19 •  7.11k •  11 

cross-encoder/ettin-reranker-1b-v1  Text Ranking •  1B • Updated May 19 •  15k •  6 

cross-encoder/ettin-reranker-32m-v1  Text Ranking •  31.9M • Updated May 19 •  9.95k •  3 

cross-encoder/ettin-reranker-400m-v1  Text Ranking •  0.4B • Updated May 19 •  7.23k •  3 

cross-encoder/ettin-reranker-68m-v1  Text Ranking •  68.1M • Updated May 19 •  9.09k •  3 

google/embeddinggemma-300m  Sentence Similarity •  0.3B • Updated Sep 25, 2025 •  1.65M •  1.78k 

jhu-clsp/ettin-encoder-17m  Fill-Mask • Updated Jul 16, 2025 •  4.13k •  19 

jhu-clsp/ettin-encoder-32m  Feature Extraction • Updated Jul 18, 2025 •  1.86k •  13 

mixedbread-ai/mxbai-rerank-large-v2  Text Ranking •  2B • Updated Apr 8 •  47k •  141 

##  Datasets mentioned in this article 5

cross-encoder/ettin-reranker-v1-data  Viewer • Updated May 21 • 143M •  871 •  7 

cross-encoder/lightonai-embeddings-fine-tuning-reranked-v1  Preview • Updated May 19 •  371 •  8 

lightonai/embeddings-fine-tuning  Viewer • Updated about 3 hours ago • 53.7M •  2.68k •  21 

lightonai/embeddings-pre-training  Viewer • Updated Apr 16 • 1.38B •  2.52k •  48 

sentence-transformers/natural-questions  Viewer • Updated Apr 30, 2024 • 100k •  3.24k •  49 

##  Collections mentioned in this article 2

Encoders vs Decoders: the Ettin Suite  Collection A collection of SOTA, open-data, paired encoder-only and decoder only models ranging from 17M params to 1B. See the paper at https://arxiv.org/abs/250 • 30 items • Updated Mar 2 •  31

NanoBEIR 🍺with BM25 Rankings  Collection NanoBEIR by Zeta Alpha, extended with BM25 scores. Used in the Sentence Transformers CrossEncoderNanoBEIREvaluator prior to ST version 5.2. • 13 items • Updated Dec 10, 2025 •  4

More Articles from our Blog

nlpcommunityresearch Falcon 2: An 11B parameter pretrained language model and VLM, trained on over 5000B tokens and 11 languages +5  28 May 24, 2024 

llmmoelong-context DeepSeek-V4: a million-token context that agents can actually use  50 April 24, 2026 
...
What a clean release, congrats @tomaarsen !
...
Article author 24 days ago 

> If I understand well, you are mixing lightOn hard negatives data (with Jang et al. stratified sampling) with broader lightonai/embeddings-pre-training - which (i think) doesn't include mined negatives

Correct on all counts. They're different data formats initially. I took:

* query-answer pair style data from <https://huggingface.co/datasets/lightonai/embeddings-pre-training> together with
* <https://huggingface.co/datasets/lightonai/embeddings-fine-tuning> \+ rescoring with mxbai-rerank-large-v2 + Jang et al. stratified sampling + subsampled to 64 docs per query + reformatted to 64 query-answer pairs.
