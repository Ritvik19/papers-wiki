...
Single-task performance of different data selection techniques over the TÜLU 2 unfiltered set.Performance against estimated compute cost of varied data selection methods when selecting 10k points from data pools consisting of 200k (left points) and 5.8M (right points) data points.
...
Large-Scale Data Selection for Instruction Tuning 2503.01807
...
By Ritvik Rastogi on March 26, 2025.
