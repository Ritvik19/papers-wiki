...
Jaykumar Kasundra's avatar 

Jaykumar Kasundra JayKasundraSNOW Follow 
...
Large Language Models (LLMs) have rapidly evolved from text-only assistants into complex _agentic_ systems capable of performing multi-step reasoning, calling external tools, retrieving memory, and executing code. With this evolution comes an increasingly sophisticated threat landscape: not only traditional content safety risks, but also multi-turn jailbreaks, prompt injections, memory hijacking, and tool manipulation. 
...
3. **Agentic Workflow** (tool calls, reasoning traces, memory, system context)
...
Aprielguard_Prompt_v3 _AprielGuard overview_
...
_(These 16 categories are inspired from SALAD-Bench)_
...
_Synthetic data generation flow_
...
| [AyaRedteaming](https://huggingface.co/datasets/CohereLabs/aya%5Fredteaming)                                      | 1.00      | 0.88   | 0.94     | NA   |
...
_A comparative assessment of model performance using aggregated results from safety benchmarks._ 
...
| Source                                                                                                     | Precision | Recall | F1-score | FPR  |
| ---------------------------------------------------------------------------------------------------------- | --------- | ------ | -------- | ---- |
| [gandalf\_ignore\_instructions](https://huggingface.co/datasets/Lakera/gandalf%5Fignore%5Finstructions)    | 1.00      | 0.91   | 0.95     | NA   |
...
_A comparative assessment of model performance using aggregated results from adversarial benchmarks._ 
...
_**Safety** performance of different models on the agentic benchmark._ 

_**Adversarial** performance of different models on the agentic benchmark.._ 
...
ServiceNow-AI/AprielGuard  Text Generation •  8B • Updated Jan 27 •  2.72k •  20 

google/madlad400-3b-mt  Translation •  3B • Updated Nov 27, 2023 •  147k •  208 

##  Datasets mentioned in this article 10

Bertievidgen/SimpleSafetyTests  Viewer • Updated Mar 25, 2024 • 100 •  784 •  12 

CohereLabs/aya\_redteaming  Viewer • Updated Mar 6 • 7.42k •  1.02k •  34 

PKU-Alignment/BeaverTails  Viewer • Updated Oct 17, 2023 • 364k •  19.3k •  110 

PKU-Alignment/PKU-SafeRLHF  Viewer • Updated Oct 18, 2024 • 164k •  14.4k •  191 

allenai/xstest-response  Viewer • Updated Jun 29, 2024 • 895 •  418 •  9 

lmsys/toxic-chat  Viewer • Updated May 14, 2024 • 20.3k •  6.51k •  197 

mmathys/openai-moderation-api-evaluation  Viewer • Updated Aug 28, 2023 • 1.68k •  843 •  38 

nvidia/Aegis-AI-Content-Safety-Dataset-1.0  Viewer • Updated Jun 9, 2025 • 12k •  746 •  61 

nvidia/Aegis-AI-Content-Safety-Dataset-2.0  Viewer • Updated Jun 9, 2025 • 33.4k •  4.37k •  101 

walledai/HarmBench  Viewer • Updated Jul 31, 2024 • 400 •  7.23k •  51 

More from this author

Can Voice Agents Handle Bilingual Customers? Benchmarking Frontier ASR on Code-Switched Speech  44 June 9, 2026 

EVA-Bench Data 2.0: 3 Domains, 121 Tools, 213 Scenarios  41 June 4, 2026 
