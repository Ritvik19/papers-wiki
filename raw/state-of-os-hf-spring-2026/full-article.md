...
Avijit Ghosh evijit Follow 

Hugging Face's avatar huggingface

Lucie-Aimée Kaffee's avatar 

Lucie-Aimée Kaffee frimelle Follow 

Hugging Face's avatar huggingface

Yacine Jernite's avatar 

Yacine Jernite yjernite Follow 
...
_Data from Hugging Face | Hugging Face's two million models and counting:_ _Graph and story by AI World_
...
_Data from Hugging Face | Big Tech Is All-In On Open-Source AI,_ _Graph and story by AI World_
...
countries_economies1 _Data from Hugging Face_ | _Graph and Research from Longpre et al. “Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem”_
...
_Data and Graph from Hugging Face_
...
natmarkshare _Data from Hugging Face_ | _Graph and Research from Longpre et al. “Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem”_
...
Top New Models(1) _Data and Graph from Hugging Face_
...
_Hugging Face Trending Page February 2026_
...
_Data and Graphic from Hugging Face_
...
_Space by Hugging Face | PaperVerse Explorer_
...
_Data from Hugging Face_ | _Graphic and story by AI World_
...
_Data from Hugging Face_ | _Graph and Article by ATOM_
...
_Data from Hugging Face_ | _Graph and Research from Choksi et al. "The Brief and Wondrous Life of Open Models"_
...
_Data from Hugging Face_ | _Graph and Research from Longpre et al. "Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem"_
...
robotics-data _Data from Hugging Face_ | _Graph and Story by AI World_
...
_Data from GitHub_ | _Graphic from_ star-history.com
...
Screenshot 2026-03-17 at 12.55.49 PM

_Space by Hugging Face | Science Release Heatmap_
...
x-humanoid-robomind/RoboMIND Updated Apr 14 •  30.3k •  43 

##  Spaces mentioned in this article 4

 Running Agents 4 PaperVerse Explorer 😻 4 Research Paper Stats on Hugging Face 

 Running 11 Different Flops for Different Folks 🌌 11 A Review of the Actual Training Costs of AI 

 Running 39 Science Release Heatmap 🔥 39 Explore AI4Science contributions by organizations and tags 

 Running Agents 1 January Hub 🏃 1 visualization of one week of downloads 
...
Building Moon Bot: A Slack-Native Coding Agent Backed by HuggingFace Buckets  46 June 24, 2026 

Introducing Serge: GitHub-Native AI Code Review  14 June 12, 2026 
