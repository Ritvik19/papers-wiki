...
There's also a **faster variant with the same intelligence** at $3.00/M input and $15.00/M output tokens, a lower cost than the fast tiers of other frontier models. Similar to Composer 2, fast is the default option.

Composer 2.5 includes double usage for the first week.

---

For more background on targeted textual feedback see:
