...
Input order study with left-to-right and top-to-bottom inputs in evaluation, where r is the proportion of shuffled samples in training.Input order study with token-shuffled inputs in evaluation, where r is the proportion of shuffled samples in training.
...
LayoutReader: Pre-training of Text and Layout for Reading Order Detection 2108.11591
...
By Ritvik Rastogi on November 7, 2024.
