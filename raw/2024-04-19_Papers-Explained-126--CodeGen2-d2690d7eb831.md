...
Recommended Reading: [Papers Explained 125: CodeGen]
...
Comparison of causal decoder and Prefix-LM on various tasks. HumanEval, Infill-Single, and Infill-Multi are evaluated as zero-shot code generation, XSum is evaluated as 1-shot summarization, SuperGLUE (BoolQ) and CodeXGLUE (defect detection) are evaluated by fine-tuning.
...
Results and Findings:
Results on LAMBADA and PIQA for NL and HumanEval for PL over number of training steps.
...
Results and Findings:
Pass@k on HumanEval under temperatures t = 0.2, 0.6, 0.8 for k = 1, 10, 100, respectively.
...
CodeGen2: Lessons for Training LLMs on Programming and Natural Languages 2305.02309
...
By Ritvik Rastogi on April 19, 2024.
