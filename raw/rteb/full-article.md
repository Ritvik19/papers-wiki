...
Frank Liu fzliu Follow 

MongoDB's avatar MongoDB

Kenneth C. Enevoldsen's avatar 

Kenneth C. Enevoldsen KennethEnevoldsen Follow 

Massive Text Embedding Benchmark's avatar mteb

Solomatin Roman's avatar 

Solomatin Roman Samoed Follow 

Massive Text Embedding Benchmark's avatar mteb

Isaac Chung's avatar 

Isaac Chung isaacchung Follow 
...
Fődi, Zoltán's avatar 

Fődi, Zoltán fzoll Follow 
...
| --------------------------- | ------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AILACasedocs                | english, legal      | Open                                                         | <https://huggingface.co/datasets/mteb/AILA%5Fcasedocs>                   | No                                                                                                                                                                                                                                                                                                                    | This dataset comprises approximately 3,000 Supreme Court of India case documents and is designed to evaluae the retrieval of relevant prior cases for given legal situations. It includes 50 queries, each outlining a specific scenario. We include this dataset in the benchmark because the documents are reasonably challenging, the queries are non-synthetic, and the labels are of high quality.                                                                                     |
| AILAStatutes                | english, legal      | Open                                                         | <https://huggingface.co/datasets/mteb/AILA%5Fstatutes>                   | No                                                                                                                                                                                                                                                                                                                    | The dataset comprises descriptions of 197 Supreme Court of India statutes, designed to facilitate the retrieval of relevant prior statutes for given legal situations. It includes 50 queries, each outlining a specific scenario. We include this dataset in the benchmark because the documents are reasonably challenging, the queries are non-synthetic, and the labels are of high quality.                                                                                            |
| LegalSummarization          | english, legal      | Open                                                         | <https://huggingface.co/datasets/mteb/legal%5Fsummarization>             | No                                                                                                                                                                                                                                                                                                                    | The dataset comprises 446 pairs of legal text excerpts and their corresponding plain English summaries, sourced from reputable websites dedicated to clarifying legal documents. The summaries have been manually reviewed for quality, ensuring that the data is clean and suitable for evaluating legal retrieval.                                                                                                                                                                        |
...
| HumanEval                   | code                | Open                                                         | <https://huggingface.co/datasets/openai/openai%5Fhumaneval>              | Yes                                                                                                                                                                                                                                                                                                                   | The HumanEval dataset released by OpenAI includes 164 programming problems with a handwritten function signature, docstring, body, and several unit tests for each problem. The dataset was handcrafted by engineers and researchers at OpenAI.                                                                                                                                                                                                                                             |
...
Hello-SimpleAI/HC3  Viewer • Updated Jan 21, 2023 • 48.6k •  12.4k •  219 

google-research-datasets/mbpp  Viewer • Updated Jan 4, 2024 • 1.4k •  161k •  232 

mteb/AILA\_casedocs  Viewer • Updated May 4, 2025 • 431 •  2.35k •  2 

mteb/AILA\_statutes  Viewer • Updated Feb 24 • 349 •  2.61k •  2 

mteb/LegalQuAD  Viewer • Updated May 4, 2025 • 600 •  2.42k •  4 

mteb/legal\_summarization  Viewer • Updated May 4, 2025 • 1.16k •  2.37k •  5 

mteb/miracl-hard-negatives Updated May 4, 2025 •  106 •  1 

openai/openai\_humaneval  Viewer • Updated Jan 4, 2024 • 164 •  216k •  395 

virattt/financebench  Viewer • Updated Oct 24, 2024 • 500 •  66 •  1 

##  Spaces mentioned in this article 1

 Running on CPU Upgrade 7.55k MTEB Leaderboard 📊 7.55k Embedding Leaderboard 
...
long-contextbenchmarknlp Introducing HELMET: Holistically Evaluating Long-context Language Models +3  42 April 16, 2025 

communityresearchnlp Letting Large Models Debate: The First Multilingual LLM Debate Competition +8  33 November 20, 2024 
