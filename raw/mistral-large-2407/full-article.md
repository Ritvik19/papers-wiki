...
**Source URL**: https://mistral.ai/news/mistral-large-2407/
...
### Mistral Large 2
 ...
 Mistral Large 2 is designed for single-node inference with long-context applications in mind – its size of 123 billion parameters allows it to run at large throughput on a single node. We are releasing Mistral Large 2 under the [ Mistral Research License ](https://mistral.ai/licenses/MRL-0.1.md), that allows usage and modification for research and non-commercial usages. For commercial usage of Mistral Large 2 requiring self-deployment, a Mistral Commercial License must be acquired by [ contacting us ](/contact/). 
...
##### Try Mistral Large 2 on la Plateforme
 ...
 You can use Mistral Large 2 today via [ la Plateforme ](https://console.mistral.ai/) under the name mistral-large-2407, and test it on le Chat. It is available under the version 24.07 (a [ YY.MM ](http://YY.MM) versioning system that we are applying to all our models), and the API name mistral-large-2407. Weights for the instruct model are [ available ](https://models.mistralcdn.com/mistral-large-2407/mistral-large-instruct-2407.tar) and are also hosted on [ HuggingFace ](https://huggingface.co/mistralai/Mistral-Large-Instruct-2407). 
