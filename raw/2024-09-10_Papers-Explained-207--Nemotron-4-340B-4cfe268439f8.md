...
The models and HelpSteer2 dataset are available at HuggingFace.
...
Key hyper-parameters affecting size of Nemotron-4–340B-Base.
Training Details

Nemotron-4–340B-Base follows the same continued pretraining recipe as Nemotron-4–15B-Base.

Base Model Evaluation
Results on standard reasoning benchmarks.
...
Synthetic single-turn prompts generation for open Q&A, writing, closed Q&A, math and coding.
...
The various prompts used are here.
...
Demonstration of the proposed Iterative Weak-to-Strong Alignment workflow.
...
Evaluation results of instruct models on automatic benchmarks.
Nemotron-4–340B-Instruct is competitive with currently available open access models.
Evaluation results of each intermediate model in the alignment process.
...
Human Evaluation
Human evaluations comparing Nemotron-4–340B-Instruct with GPT-4–1106-preview across ten task categories.
...
Human evaluation results regarding perception of response length.
...
Nemotron-4 340B Technical Report 2406.11704
...
By Ritvik Rastogi on September 10, 2024.
