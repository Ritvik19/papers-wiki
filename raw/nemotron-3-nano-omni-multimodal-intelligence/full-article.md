...
Tuomas Rintamaki's avatar 

Tuomas Rintamaki trintamaki Follow 

NVIDIA's avatar nvidia

Amala Sanjay Deshmukh's avatar 

Amala Sanjay Deshmukh amalad Follow 

NVIDIA's avatar nvidia

Nabin Mulepati's avatar 

Nabin Mulepati nabinnvidia Follow 

NVIDIA's avatar nvidia

Collin McCarthy's avatar 

Collin McCarthy cmccarthy Follow 

NVIDIA's avatar nvidia

Pritam Biswas's avatar 

Pritam Biswas pritamb Follow 

NVIDIA's avatar nvidia

Arushi Goel's avatar 

Arushi Goel goarushi27 Follow 

NVIDIA's avatar nvidia

Alexandre Milesi's avatar 

Alexandre Milesi milesial Follow 

NVIDIA's avatar nvidia

Danial Mohseni Taheri's avatar 

Danial Mohseni Taheri DanialMT Follow 

NVIDIA's avatar nvidia

Kateryna Chumachenko's avatar 

Kateryna Chumachenko katerynaCh Follow 

NVIDIA's avatar nvidia

Isabel Hulseman's avatar 

Isabel Hulseman ihulseman0220 Follow 

NVIDIA's avatar nvidia

Zhehuai Chen's avatar 

Zhehuai Chen chenzhehuai Follow 

NVIDIA's avatar nvidia

Karan's avatar 

Karan karansapra Follow 
...
Leili Tavabi's avatar 

Leili Tavabi leilii Follow 

NVIDIA's avatar nvidia

Ehsan Hosseini Asl's avatar 

Ehsan Hosseini Asl ehosseiniasl Follow 
...
Efficiency-Plots _Figure 1\. Total system throughput for multi-document and video use cases sustained by each model at a fixed per‑user interactivity threshold (tokens/sec/user)_ 
...
Nemotron_arch_v3_reducedFigure 2\. Model architecture of NVIDIA Nemotron 3 Nano Omni 30B-A3B
...
adobe-multipage-reasoning-visual-v6Figure 3: Stylized example from the MMLongBench-Doc benchmark
...
**Image** Screenshot 2026-04-27 at 12.29.11 PM
...
| Megatron-Bridge                | <https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/vlm/nemotron%5F3%5Fomni> |
| Nemo-RL                        | <https://github.com/NVIDIA-NeMo/RL/blob/nano-v3-omni/docs/guides/nemotron-3-nano-omni.md>          |
| NeMo Data Designer SDG recipes | <https://github.com/NVIDIA-NeMo/DataDesigner/tree/main/docs/assets/recipes/vlm%5Flong%5Fdoc>       |
...
nvidia/C-RADIOv4-H  Feature Extraction •  0.7B • Updated Jan 30 •  13.6k •  77 

nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning-BF16  Any-to-Any •  33B • Updated May 8 •  1.03M •  375 

nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning-FP8  Any-to-Any •  33B • Updated May 5 •  114k •  58 

nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning-NVFP4  Any-to-Any •  18B • Updated May 5 •  2.21M •  152 

nvidia/parakeet-tdt-0.6b-v3  Automatic Speech Recognition •  0.6B • Updated 11 days ago •  98.6k •  987 

##  Datasets mentioned in this article 1

nvidia/Nemotron-Image-Training-v3  Viewer • Updated Apr 28 • 6.92M •  3.87k •  75 

##  Spaces mentioned in this article 1

 Running Agents 3 MMLongBench Doc 🥇 3 A long-context, multimodal document understanding benchmark 

More from this author

Data for Agents  14 July 8, 2026 

NVIDIA Isaac Teleop and GR00T 1.7 Open VLA Model Available in LeRobot  6 July 7, 2026 
...
Amazing work to all of you. I've been playing around with the exact problem here for another usecase. Looking forward to the condensed / local model!

I'm running parakeet-tdt 0.6b-v3 + 1.1b and faster-whisper-v3-turbo as part of a 7-pipeline local stt benchmark on my dropbox corpus (pdf's, images, ppts, keynotes, wavs, mp4s, ...) from meetings and other personal projects on a 4090, so seeing the parakeet encoder + mamba-moe + c-radiov4 combo here is the architectural step i was hoping someone would make.

Two practical questions:

1. Is nvfp4 RTF and vram on a 24gb consumer card. fp8 sits \~30gb, bf16 \~60, so nvfp4 is the only realistic path on a 4090\. is megatron-bridge the inference route you'd point at, or NeMo-RL?
2. Every cell in your eval is English. I have hours of 4-speaker dutch/flemish meeting audio (20-30 min runs) and EU PDFs with no MMLongBench-Doc equivalent. If the dataset isn't too big id' be happy to publish a head-to-head vs my parakeet+pyannote and whisper-v3-turbo baselines if a non-english signal is useful , blog post or repo PR, whichever lands. Or if there's plans to test it in other languages?
...
Thank you for releasing Nemotron 3 Nano Omni.

Would it be possible to share any intermediate-stage checkpoints, such as checkpoints before the final alignment stage or during joint training? Even a few representative checkpoints would be very helpful for research analysis.

We would follow the model license and citation requirements.
