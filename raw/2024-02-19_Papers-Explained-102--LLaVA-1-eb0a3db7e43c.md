...
LLaVA (Large Language and Vision Assistant) is an end-to-end trained large multimodal model that connects a vision encoder (CLIP) and an…
...
Recommended Reading [Papers Explained 100: CLIP] [Papers Explained 101: Vicuna]
...
Contexts i.e. captions and boxes used to prompt GPT.
...
The prompt construction process for collecting query[‘response’] from query[‘context’].
...
Instruction-following capability comparison using relative scores on LLaVA-Bench (In-theWild).
...
ScienceQA
Accuracy (%) on Science QA dataset. Question categories: NAT = natural science, SOC = social science, LAN = language science, TXT = text context, IMG = image context, NO = no context, G1–6 = grades 1–6, G7–12 = grades 7–12.
...
By Ritvik Rastogi on February 19, 2024.
