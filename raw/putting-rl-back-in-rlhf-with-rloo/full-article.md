...
Shengyi Costa Huang's avatar 

Shengyi Costa Huang vwxyzjn Follow 

Arash Ahmadian's avatar 

Arash Ahmadian ArashAhmadian Follow 

CohereForAI's avatar CohereForAI
...
* <https://huggingface.co/docs/trl/main/en/rloo%5Ftrainer>
* <https://huggingface.co/docs/trl/main/en/ppov2%5Ftrainer>
...
* <https://huggingface.co/docs/trl/main/en/rloo%5Ftrainer#benchmark-experiments>
* <https://huggingface.co/docs/trl/main/en/rloo%5Ftrainer#benchmark-experiments>
...
In practice, we noticed PPO nulls the gradient of approximately 3% of the batch data, whereas RLOO nulls about 20-40% of the batch data. Theoretically, RLOO should null 0% of the batch data when not using mini-batches. Importantly, we observe that the clipping ratio for RLOO did not change significantly once we increased the number of gradient steps before generating new batches (through num\_ppo\_epochs and num\_mini\_batches); this provides empirical evidence that the clipping ratio is indeed due to numerical issues with bf16 as opposed to the behavior and latest policies being significantly different, as positioned in the paper. 
...
trl-internal-testing/example-images  Viewer • Updated Dec 17, 2024 • 3 •  13.1k 

##  Collections mentioned in this article 1

RLOO / PPOv2 TL;DR summarize checkpoints  Collection 4 items • Updated Jun 11, 2024 •  1

More Articles from our Blog

researchrlrlhf Constitutional AI with Open LLMs +3  17 February 1, 2024 

rlrlhfnlp Preference Tuning LLMs with Direct Preference Optimization Methods +1  84 January 18, 2024 
