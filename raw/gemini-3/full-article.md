Source URL: https://blog.google/products-and-platforms/products/gemini/gemini-3/
...
See all AI updates  
   ...
   * Technology  
    ...
    See all  
Learn more:  
Google DeepMind blog Google Research blog Google Developers blog Google Cloud blog  
 See all AI updates
* Products & platforms  
 Products & platforms  
   * Products  
...
See all product updates  
   ...
   * Devices  
    ...
    See all  
Learn more:  
Google Ads & Commerce blog Waze blog  
 See all product updates
* Company news  
 Company news  
...
SundarPichai_2x.jpg Sundar Pichai  CEO, Google and Alphabet Demis_headshot Demis Hassabis  CEO, Google DeepMind koray Koray Kavukcuoglu  CTO, Google DeepMind and Chief AI Architect, Google 
...
_Demis Hassabis, CEO of Google DeepMind and Koray Kavukcuoglu, CTO of Google DeepMind and Chief AI Architect, Google, on behalf of the Gemini team_
...
_Gemini 3 can code a visualization of plasma flow in a tokamak and write a poem capturing the physics of fusion._
...
_Google Antigravity uses Gemini 3 to drive an end-to-end agentic workflow for a flight tracker app. The agent independently plans, codes the application and validates its execution through browser-based computer use._
...
Gemini models 9 demos of Gemini Omni and Gemini 3.5 in action  By Zahra Thompson  May 29, 2026 

AI Catch up on 12 major I/O 2026 moments  By Zahra Thompson  May 28, 2026 

NotebookLM Dive deeper into I/O 2026 with NotebookLM.  May 27, 2026 

Google DeepMind Running Guide agent: A step towards running unbounded  By Robin Dua & Miguel de Andrés-Clavera  May 20, 2026 
