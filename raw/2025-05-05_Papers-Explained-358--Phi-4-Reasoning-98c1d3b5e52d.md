...
Phi-4-reasoning is a 14-billion parameter reasoning model that achieves strong performance on complex reasoning tasks. It is trained via…
...
Behaviour of Phi-4-reasoning-plus during the first 125 GRPO updates.
...
Distribution of pass@1 accuracy on AIME 2025.
...
Performance breakdown by years (from 1983 to 2025) for AIME on 5 independent runs.GPQA accuracy and token usage by high-level domain.
...
Average pass@1 accuracy of models across general-purpose benchmarks evaluated averaged over five generations.
...
Phi-4-reasoning Technical Report 2504.21318
...
By Ritvik Rastogi on May 5, 2025.
