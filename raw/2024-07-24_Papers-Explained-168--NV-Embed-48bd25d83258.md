...
NV-Embed proposes a latent attention layer to obtain pooled embeddings and removes causal attention mask during contrastive training to…
...
Instructions and number of samples used for each training dataset.Instructions used for evaluation on the MTEB benchmark. “STS*” indicates we use the same instructions for all the STS tasks.
Retrieval datasets:
...
Ablation Studies
Averaged MTEB scores on seven tasks after first stage training.Averaged MTEB scores on seven tasks after second stage training.
...
NV-Embed: Improved Techniques for Training LLMs as Generalist Embedding Models 2405.17428

Recommended Reading [Representation Learning]
...
By Ritvik Rastogi on July 24, 2024.
