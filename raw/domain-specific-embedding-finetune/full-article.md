...
Oliver Holworthy's avatar 

Oliver Holworthy nvidia-oliver-holworthy Follow 
...
1. Embedding Model
2. GitHub
3. Synthetic dataset on NVIDIA’s public documents

###  🧑‍💻Open Source Projects Recipe Integrates: 

1. NeMo Data Designer for synthetic data generation
2. NeMo Automodel for embedding model training
3. BEIR for Information retrieval evaluation
4. NeMo Export-Deploy for ONNX/TensorRT conversion
5. NVIDIA NIM for production inference serving
...
nvidia/llama-nemotron-embed-1b-v2  Feature Extraction •  1B • Updated May 20 •  680k •  59 

##  Datasets mentioned in this article 1

nvidia/Retrieval-Synthetic-NVDocs-v1  Viewer • Updated Mar 30 • 15.1k •  350 •  18 
...
Article author Apr 2 

Thanks for the feedback. We will add the support in the next release of the recipe. 
