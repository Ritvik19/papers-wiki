...
[News](https://thinkingmachines.ai/news/)
[Join us](https://thinkingmachines.ai/#join-us)
[Home](https://thinkingmachines.ai/)
[Tinker](https://thinkingmachines.ai/tinker/)
[Connectionism](https://thinkingmachines.ai/blog/)
[News](https://thinkingmachines.ai/news/)
[Join us](https://thinkingmachines.ai/#join-us)
...
- [What matters for LoRA](https://thinkingmachines.ai/blog/lora/#what-matters-for-lora)
- [Methods and results](https://thinkingmachines.ai/blog/lora/#methods-and-results)

        [LoRA rank](https://thinkingmachines.ai/blog/lora/#lora-rank)
        [Batch size effects](https://thinkingmachines.ai/blog/lora/#batch-size-effects)


- [LoRA rank](https://thinkingmachines.ai/blog/lora/#lora-rank)
- [Batch size effects](https://thinkingmachines.ai/blog/lora/#batch-size-effects)
- [Layers Where LoRA Is Applied](https://thinkingmachines.ai/blog/lora/#layers-where-lora-is-applied)

        [Reinforcement learning](https://thinkingmachines.ai/blog/lora/#reinforcement-learning)


- [Reinforcement learning](https://thinkingmachines.ai/blog/lora/#reinforcement-learning)
- [Setting LoRA hyperparameters](https://thinkingmachines.ai/blog/lora/#setting-lora-hyperparameters)

        [Optimal learning rate and rank](https://thinkingmachines.ai/blog/lora/#optimal-learning-rate-and-rank)
        [Parametrization invariances](https://thinkingmachines.ai/blog/lora/#parametrization-invariances)
        [Optimal learning rates for LoRA vs. FullFT](https://thinkingmachines.ai/blog/lora/#optimal-learning-rates-for-lora-vs-fullft)
        [Learning rates in short and long runs](https://thinkingmachines.ai/blog/lora/#learning-rates-in-short-and-long-runs)
...
- [Optimal learning rates for LoRA vs. FullFT](https://thinkingmachines.ai/blog/lora/#optimal-learning-rates-for-lora-vs-fullft)
- [Learning rates in short and long runs](https://thinkingmachines.ai/blog/lora/#learning-rates-in-short-and-long-runs)
- [Discussion](https://thinkingmachines.ai/blog/lora/#discussion)

        [Why LoRA might be needed on all layers](https://thinkingmachines.ai/blog/lora/#why-lora-might-be-needed-on-all-layers)
        [How much capacity is needed by supervised and reinforcement learning?](https://thinkingmachines.ai/blog/lora/#how-much-capacity-is-needed-by-supervised-and-reinforcement-learning)
        [Compute efficiency advantage of LoRA](https://thinkingmachines.ai/blog/lora/#compute-efficiency-advantage-of-lora)
        [Open questions](https://thinkingmachines.ai/blog/lora/#open-questions)
...
- [Compute efficiency advantage of LoRA](https://thinkingmachines.ai/blog/lora/#compute-efficiency-advantage-of-lora)
- [Open questions](https://thinkingmachines.ai/blog/lora/#open-questions)
- [Closing thoughts](https://thinkingmachines.ai/blog/lora/#closing-thoughts)
- [Acknowledgements](https://thinkingmachines.ai/blog/lora/#acknowledgements)
- [Citation](https://thinkingmachines.ai/blog/lora/#citation)
[What matters for LoRA](https://thinkingmachines.ai/blog/lora/#what-matters-for-lora)
[Methods and results](https://thinkingmachines.ai/blog/lora/#methods-and-results)
- [LoRA rank](https://thinkingmachines.ai/blog/lora/#lora-rank)
- [Batch size effects](https://thinkingmachines.ai/blog/lora/#batch-size-effects)
...
1. 
The scale factor $α$ which appears in $α / r$.

2. 
The learning rate for the down-projection matrix $A$, $LR_A$

3. 
The learning rate for the up-projection matrix $B$, $LR_B$.

4. 
The initialization scale of matrix $A$, $\text{init}_A$. For a random initialization, this is the standard deviation of $A$’s initial elements. Matrix $B$ is initialized to zero, so there is no need to define $\text{init}_B$.
...
LoRA+[LoRA+: Efficient Low Rank Adaptation of Large Models](https://arxiv.org/abs/2402.12354) (Hayou et al, 2024) proposes to use different LRs on $A$ and $B$, with a higher rate for $B$. Expressed in terms of our basis above, increasing $LR_B$ is equivalent to increasing $\text{init}_A/LR_A$ so that $A$ changes on a longer timescale.
...
```
@article{schulman2025lora, author = {John Schulman and Thinking Machines Lab}, title = {LoRA Without Regret}, journal = {Thinking Machines Lab: Connectionism}, year = {2025}, note = {https://thinkingmachines.ai/blog/lora/}, doi = {10.64434/tml.20250929}, }
```
...
[prev](https://thinkingmachines.ai/blog/modular-manifolds/)
[back to top](https://thinkingmachines.ai/blog/lora/)
[next](https://thinkingmachines.ai/blog/on-policy-distillation/)
[Thinking Machines Lab](https://thinkingmachines.ai/)
[Terms of service](https://thinkingmachines.ai/legal/tos/)
[Privacy notice](https://thinkingmachines.ai/legal/privacy)
