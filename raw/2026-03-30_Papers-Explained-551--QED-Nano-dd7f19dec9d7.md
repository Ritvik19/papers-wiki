...
QED-Nano is a compact 4B model post-trained to write Olympiad-level mathematical proofs and operates entirely in natural language, with no…
...
Evaluation
Comparison of QED-Nano (4B) with leading open- and closed-source models.Performance of QED-Nano (4B) within just a single response turn of 50,000 tokens.
...
By Ritvik Rastogi on March 30, 2026.
