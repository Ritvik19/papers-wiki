...
- The parameters of the controller LSTM $\theta$ are trained with  [REINFORCE](https://lilianweng.github.io/posts/2018-04-08-policy-gradient/#reinforce) , where the reward $R(\mathbf{m}, \omega)$ is computed on the validation set.
