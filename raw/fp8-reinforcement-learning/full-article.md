Source URL: https://unsloth.ai/docs/get-started/reinforcement-learning-rl-guide/fp8-reinforcement-learning
Title: FP8 Reinforcement Learning

> For the complete documentation index, see [llms.txt](https://unsloth.ai/docs/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://unsloth.ai/docs/get-started/reinforcement-learning-rl-guide/fp8-reinforcement-learning.md).
...
Our FP8 support uses Unsloth’s [weight-sharing feature](/docs/get-started/reinforcement-learning-rl-guide/memory-efficient-rl.md), reducing VRAM use by another **50%**, enabling **10× more** context with no accuracy loss. We use [vLLM](https://github.com/vllm-project/vllm) for fast inference and, our techniques like Unsloth [Standby](/docs/get-started/reinforcement-learning-rl-guide/memory-efficient-rl.md) and [Flex Attention](/docs/models/gpt-oss-how-to-run-and-fine-tune/long-context-gpt-oss-training.md) to further reduce VRAM use. TorchAO enables universal on the fly FP8, so Llama, Gemma, Mistral & more work. We’ve also [uploaded](#unsloth-fp8-uploads) most FP8 models (including Qwen3).

<figure><img src="/files/0mcYYA6rBLlf5FenaFkm" alt="" width="375"><figcaption><p>Reward plot shows FP8 following the same trend as BF16</p></figcaption></figure>
...
<figure><img src="/files/Du9d5uOhNIAM35dnC2IH" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="/files/kTlpQVU8I8aU7RXLH51b" alt=""><figcaption></figcaption></figure>
{% endcolumn %}

{% column %}

<figure><img src="/files/DmtXH21v0F0XVF2XuZay" alt=""><figcaption></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
...
<figure><img src="/files/JqFuhOnrEbnmP5rzylrb" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/MBEqubEs6p7UMm0NFDID" alt=""><figcaption></figcaption></figure>
{% endcolumn %}

{% column width="50%" %}

<figure><img src="/files/jApQ5aM2mBHByADFuYkY" alt=""><figcaption></figcaption></figure>

<figure><img src="/files/OrmJPXOmhRoUDQnLLqXY" alt=""><figcaption></figcaption></figure>
{% endcolumn %}
{% endcolumns %}

### :shinto\_shrine:Inference = 96% of RL training

<figure><img src="/files/nWBrWRYWsweFOSQG7nlg" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/7622oAMDyfw4ASdxmV7c" alt=""><figcaption></figcaption></figure>
...
Also reminder in Unsloth we share vLLM's memory space for the weights as introduced in [Memory Efficient RL](/docs/get-started/reinforcement-learning-rl-guide/memory-efficient-rl.md) - we have bought this trick over to the FP8 domain!
...
To enable [Unsloth Standby](/docs/get-started/reinforcement-learning-rl-guide/memory-efficient-rl.md) for FP8 (or BF16) RL, simply add the below to all RL / GRPO training runs before any Unsloth import:
...
<figure><img src="/files/lvU8hNff8bN02wTcvHcc" alt="" width="375"><figcaption></figcaption></figure>
...
This general setup works across all supported RL algorithms, including [GSPO](/docs/get-started/reinforcement-learning-rl-guide/advanced-rl-documentation/gspo-reinforcement-learning.md), Dr. GRPO, PPO, and DPO.

<figure><img src="/files/0oIaeJxZftqvW2u8kkGc" alt="" width="375"><figcaption></figcaption></figure>
...
For convenience, we uploaded FP8 Dynamic and FP8 Block models on Hugging Face. You can use them for FP8 training or also efficient & fast serving/deployment via [vLLM](/docs/basics/inference-and-deployment/vllm-guide.md)/[SGLang](/docs/basics/inference-and-deployment/sglang-guide.md) etc.

FP8 Dynamic offers slightly faster training and lower VRAM usage than FP8 Block, but with a small trade-off in accuracy. [See here](/docs/get-started/unsloth-model-catalog.md#fp8) for our full list of FP8 quants, but here the most popular ones:
...
```
GET https://unsloth.ai/docs/get-started/reinforcement-learning-rl-guide/fp8-reinforcement-learning.md?ask=<question>&goal=<endgoal>
```
