...
**Source URL**: https://mistral.ai/news/mistral-medium-3/
...
2. SOTA performance
3. 8X lower cost
4. simpler deployability to accelerate enterprise usage
5. The model leads in professional use cases such as coding and multimodal understanding
6. The model delivers a range of enterprise capabilities including:
7. Hybrid or on-premises / in-VPC deployment
8. Custom post-training
9. Integration into enterprise tools and systems
