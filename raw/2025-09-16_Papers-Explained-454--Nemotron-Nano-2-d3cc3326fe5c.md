...
Nemotron-Nano-9B-v2 is a hybrid Mamba-Transformer language model designed to increase throughput for reasoning workloads while achieving…
...
Model Architecture
Nemotron-Nano-12B-v2-Base layer pattern.Summary of Nemotron-Nano-12B-v2-Base architecture.
...
By Ritvik Rastogi on September 16, 2025.
