...
Command A is an agent-optimized and multilingual-capable model, with support for 23 languages of global business: English, French, Spanish…
...
Standard Benchmarks
Results for Command A on standard academic benchmarks.
...
Machine translation (COMET-20) scores on NTREX.Command A mArenaHard winrates against on 23 languages against open-weights models.

Multilingual Taubench Results.Crosslingual line-level pass rate (LPR) from the Language Confusion Benchmark.ADI2 score over monolingual and crosslingual prompts in 4 Arabic dialects (Egyptian, Saudi, Syrian, Moroccan).
...
Math and Reasoning
Reasoning performance of Command A compared to similarly-sized models.
...
Results on the RULER long context benchmark.LongBench-V2 results for Command A.
...
Command A: An Enterprise-Ready Large Language Model 2504.00698
...
By Ritvik Rastogi on April 15, 2025.
