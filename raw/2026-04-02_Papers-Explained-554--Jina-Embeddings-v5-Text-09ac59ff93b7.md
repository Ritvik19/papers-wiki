...
The paper introduces jina-embeddings-v5-text, a family of compact text embedding models trained with a novel regimen that combines model…
...
Model Architecture
Model Architecture.Attributes of the Base Models and the Resulting Embedding Models.
...
jina-embeddings-v5-text: Task-Targeted Embedding Distillation 2602.15547
...
By Ritvik Rastogi on April 2, 2026.
