...
**Source URL**: https://mistral.ai/news/leanstral/
...
![Leanstrall Normalized Model Cost Vs Flt Eval Score](/_astro/78aaa774-c717-4c60-b71b-1161487b28e5_Z1xTnFQ.webp?dpl=6a22ec9594e7d400080f6dd3)
...
```
-- Example command: adds 2 to variable Xdef plus2 : com := .CAss "X" (.APlus (.AId "X") (.ANum 2))
...
- Zero-Setup in Mistral Vibe: We’ve integrated Leanstral directly into Mistral Vibe for immediate, zero-setup vibe coding and proving. Use/leanstallto active.  Then to use Leanstral pressShift+Tabuntil the model displays as Leanstral,  Alternately, usevibe --agent lean.
Zero-Setup in Mistral Vibe: We’ve integrated Leanstral directly into Mistral Vibe for immediate, zero-setup vibe coding and proving. Use/leanstallto active.  Then to use Leanstral pressShift+Tabuntil the model displays as Leanstral,  Alternately, usevibe --agent lean.
